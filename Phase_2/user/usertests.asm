...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0c250513          	addi	a0,a0,194 # 6100 <malloc+0x104>
      ...
      74:	8082                	ret
{
      ...
      84:	0a050513          	addi	a0,a0,160 # 6120 <malloc+0x124>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	09050513          	addi	a0,a0,144 # 6138 <malloc+0x13c>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	09250513          	addi	a0,a0,146 # 6158 <malloc+0x15c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	05a50513          	addi	a0,a0,90 # 6140 <malloc+0x144>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	06650513          	addi	a0,a0,102 # 6168 <malloc+0x16c>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	06450513          	addi	a0,a0,100 # 6190 <malloc+0x194>
     134:	00006097          	auipc	ra,0x6
     138:	ae2080e7          	jalr	-1310(ra) # 5c16 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	05050513          	addi	a0,a0,80 # 6190 <malloc+0x194>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	04c58593          	addi	a1,a1,76 # 61a0 <malloc+0x1a4>
     15c:	00006097          	auipc	ra,0x6
     160:	a8a080e7          	jalr	-1398(ra) # 5be6 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	02850513          	addi	a0,a0,40 # 6190 <malloc+0x194>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	02c58593          	addi	a1,a1,44 # 61a8 <malloc+0x1ac>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	ffc50513          	addi	a0,a0,-4 # 6190 <malloc+0x194>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fe650513          	addi	a0,a0,-26 # 61b0 <malloc+0x1b4>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f5c50513          	addi	a0,a0,-164 # 61d8 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f48a8a93          	addi	s5,s5,-184 # 61d8 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	ed650513          	addi	a0,a0,-298 # 61e8 <malloc+0x1ec>
     ...
     33a:	ed250513          	addi	a0,a0,-302 # 6208 <malloc+0x20c>
     33e:	00006097          	auipc	ra,0x6
     342:	c00080e7          	jalr	-1024(ra) # 5f3e <printf>
        exit(1);
     346:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	ec050513          	addi	a0,a0,-320 # 6220 <malloc+0x224>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     378:	eac98993          	addi	s3,s3,-340 # 6220 <malloc+0x224>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	e6050513          	addi	a0,a0,-416 # 6220 <malloc+0x224>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	dd058593          	addi	a1,a1,-560 # 61a8 <malloc+0x1ac>
    ...
    printf("write failed\n");
     ...
     3f2:	e5250513          	addi	a0,a0,-430 # 6240 <malloc+0x244>
     3f6:	00006097          	auipc	ra,0x6
     3fa:	b48080e7          	jalr	-1208(ra) # 5f3e <printf>
    exit(1);
     3fe:	4505                	li	a0,1
     ...
     40c:	e2050513          	addi	a0,a0,-480 # 6228 <malloc+0x22c>
     410:	00006097          	auipc	ra,0x6
     414:	b2e080e7          	jalr	-1234(ra) # 5f3e <printf>
      exit(1);
     418:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     426:	e0650513          	addi	a0,a0,-506 # 6228 <malloc+0x22c>
     42a:	00006097          	auipc	ra,0x6
     42e:	b14080e7          	jalr	-1260(ra) # 5f3e <printf>
    exit(1);
     432:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     44a:	dda50513          	addi	a0,a0,-550 # 6220 <malloc+0x224>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	cfea0a13          	addi	s4,s4,-770 # 6250 <malloc+0x254>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	c5a50513          	addi	a0,a0,-934 # 6258 <malloc+0x25c>
     606:	00006097          	auipc	ra,0x6
     60a:	938080e7          	jalr	-1736(ra) # 5f3e <printf>
      exit(1);
     60e:	4505                	li	a0,1
     ...
     620:	c5450513          	addi	a0,a0,-940 # 6270 <malloc+0x274>
     624:	00006097          	auipc	ra,0x6
     628:	91a080e7          	jalr	-1766(ra) # 5f3e <printf>
      exit(1);
     62c:	4505                	li	a0,1
     ...
     63e:	c6650513          	addi	a0,a0,-922 # 62a0 <malloc+0x2a4>
     642:	00006097          	auipc	ra,0x6
     646:	8fc080e7          	jalr	-1796(ra) # 5f3e <printf>
      exit(1);
     64a:	4505                	li	a0,1
     ...
     658:	c7c50513          	addi	a0,a0,-900 # 62d0 <malloc+0x2d4>
     65c:	00006097          	auipc	ra,0x6
     660:	8e2080e7          	jalr	-1822(ra) # 5f3e <printf>
      exit(1);
     664:	4505                	li	a0,1
     ...
     676:	c6e50513          	addi	a0,a0,-914 # 62e0 <malloc+0x2e4>
     67a:	00006097          	auipc	ra,0x6
     67e:	8c4080e7          	jalr	-1852(ra) # 5f3e <printf>
      exit(1);
     682:	4505                	li	a0,1
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b4:	c60a0a13          	addi	s4,s4,-928 # 6310 <malloc+0x314>
    n = write(fds[1], "x", 1);
     6b8:	00006a97          	auipc	s5,0x6
     6bc:	af0a8a93          	addi	s5,s5,-1296 # 61a8 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	bba50513          	addi	a0,a0,-1094 # 6318 <malloc+0x31c>
     766:	00005097          	auipc	ra,0x5
     76a:	7d8080e7          	jalr	2008(ra) # 5f3e <printf>
      exit(1);
     76e:	4505                	li	a0,1
     ...
     780:	bb450513          	addi	a0,a0,-1100 # 6330 <malloc+0x334>
     784:	00005097          	auipc	ra,0x5
     788:	7ba080e7          	jalr	1978(ra) # 5f3e <printf>
      exit(1);
     78c:	4505                	li	a0,1
     ...
     79a:	b3a50513          	addi	a0,a0,-1222 # 62d0 <malloc+0x2d4>
     79e:	00005097          	auipc	ra,0x5
     7a2:	7a0080e7          	jalr	1952(ra) # 5f3e <printf>
      exit(1);
     7a6:	4505                	li	a0,1
     ...
     7b4:	bb050513          	addi	a0,a0,-1104 # 6360 <malloc+0x364>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	786080e7          	jalr	1926(ra) # 5f3e <printf>
      exit(1);
     7c0:	4505                	li	a0,1
     ...
     7d2:	baa50513          	addi	a0,a0,-1110 # 6378 <malloc+0x37c>
     7d6:	00005097          	auipc	ra,0x5
     7da:	768080e7          	jalr	1896(ra) # 5f3e <printf>
      exit(1);
     7de:	4505                	li	a0,1
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	97c58593          	addi	a1,a1,-1668 # 61a0 <malloc+0x1a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	95050513          	addi	a0,a0,-1712 # 6190 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	92450513          	addi	a0,a0,-1756 # 6190 <malloc+0x194>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	91050513          	addi	a0,a0,-1776 # 6190 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	b4a58593          	addi	a1,a1,-1206 # 6408 <malloc+0x40c>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	89050513          	addi	a0,a0,-1904 # 6190 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	a6450513          	addi	a0,a0,-1436 # 63a8 <malloc+0x3ac>
     94c:	00005097          	auipc	ra,0x5
     950:	5f2080e7          	jalr	1522(ra) # 5f3e <printf>
    exit(1);
     954:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	a6850513          	addi	a0,a0,-1432 # 63c8 <malloc+0x3cc>
     968:	00005097          	auipc	ra,0x5
     96c:	5d6080e7          	jalr	1494(ra) # 5f3e <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     970:	8652                	mv	a2,s4
     972:	85d6                	mv	a1,s5
     974:	00006517          	auipc	a0,0x6
     978:	a6450513          	addi	a0,a0,-1436 # 63d8 <malloc+0x3dc>
     97c:	00005097          	auipc	ra,0x5
     980:	5c2080e7          	jalr	1474(ra) # 5f3e <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	a6850513          	addi	a0,a0,-1432 # 63f8 <malloc+0x3fc>
     998:	00005097          	auipc	ra,0x5
     99c:	5a6080e7          	jalr	1446(ra) # 5f3e <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     9a0:	8652                	mv	a2,s4
     9a2:	85d6                	mv	a1,s5
     9a4:	00006517          	auipc	a0,0x6
     9a8:	a3450513          	addi	a0,a0,-1484 # 63d8 <malloc+0x3dc>
     9ac:	00005097          	auipc	ra,0x5
     9b0:	592080e7          	jalr	1426(ra) # 5f3e <printf>
    exit(1);
     9b4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	a4e50513          	addi	a0,a0,-1458 # 6410 <malloc+0x414>
     9ca:	00005097          	auipc	ra,0x5
     9ce:	574080e7          	jalr	1396(ra) # 5f3e <printf>
    exit(1);
     9d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	a5050513          	addi	a0,a0,-1456 # 6430 <malloc+0x434>
     9e8:	00005097          	auipc	ra,0x5
     9ec:	556080e7          	jalr	1366(ra) # 5f3e <printf>
    exit(1);
     9f0:	4505                	li	a0,1
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	a3c50513          	addi	a0,a0,-1476 # 6450 <malloc+0x454>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	a4c98993          	addi	s3,s3,-1460 # 6478 <malloc+0x47c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	a7ca8a93          	addi	s5,s5,-1412 # 64b0 <malloc+0x4b4>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	9d650513          	addi	a0,a0,-1578 # 6450 <malloc+0x454>
  ...
  if(unlink("small") < 0){
     ...
     aba:	99a50513          	addi	a0,a0,-1638 # 6450 <malloc+0x454>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	97850513          	addi	a0,a0,-1672 # 6458 <malloc+0x45c>
     ae8:	00005097          	auipc	ra,0x5
     aec:	456080e7          	jalr	1110(ra) # 5f3e <printf>
    exit(1);
     af0:	4505                	li	a0,1
     ...
     b02:	98a50513          	addi	a0,a0,-1654 # 6488 <malloc+0x48c>
     b06:	00005097          	auipc	ra,0x5
     b0a:	438080e7          	jalr	1080(ra) # 5f3e <printf>
      exit(1);
     b0e:	4505                	li	a0,1
     ...
     b20:	9a450513          	addi	a0,a0,-1628 # 64c0 <malloc+0x4c4>
     b24:	00005097          	auipc	ra,0x5
     b28:	41a080e7          	jalr	1050(ra) # 5f3e <printf>
      exit(1);
     b2c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	9b050513          	addi	a0,a0,-1616 # 64e8 <malloc+0x4ec>
     b40:	00005097          	auipc	ra,0x5
     b44:	3fe080e7          	jalr	1022(ra) # 5f3e <printf>
    exit(1);
     b48:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	9b450513          	addi	a0,a0,-1612 # 6508 <malloc+0x50c>
     b5c:	00005097          	auipc	ra,0x5
     b60:	3e2080e7          	jalr	994(ra) # 5f3e <printf>
    exit(1);
     b64:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	9b050513          	addi	a0,a0,-1616 # 6520 <malloc+0x524>
     b78:	00005097          	auipc	ra,0x5
     b7c:	3c6080e7          	jalr	966(ra) # 5f3e <printf>
    exit(1);
     b80:	4505                	li	a0,1
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	99e50513          	addi	a0,a0,-1634 # 6540 <malloc+0x544>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	94c50513          	addi	a0,a0,-1716 # 6540 <malloc+0x544>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	90c50513          	addi	a0,a0,-1780 # 6548 <malloc+0x54c>
     c44:	00005097          	auipc	ra,0x5
     c48:	2fa080e7          	jalr	762(ra) # 5f3e <printf>
    exit(1);
     c4c:	4505                	li	a0,1
     ...
     c5e:	90e50513          	addi	a0,a0,-1778 # 6568 <malloc+0x56c>
     c62:	00005097          	auipc	ra,0x5
     c66:	2dc080e7          	jalr	732(ra) # 5f3e <printf>
      exit(1);
     c6a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	91a50513          	addi	a0,a0,-1766 # 6590 <malloc+0x594>
     c7e:	00005097          	auipc	ra,0x5
     c82:	2c0080e7          	jalr	704(ra) # 5f3e <printf>
    exit(1);
     c86:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca6:	89e50513          	addi	a0,a0,-1890 # 6540 <malloc+0x544>
     ...
     cd2:	8e250513          	addi	a0,a0,-1822 # 65b0 <malloc+0x5b4>
     cd6:	00005097          	auipc	ra,0x5
     cda:	268080e7          	jalr	616(ra) # 5f3e <printf>
        exit(1);
     cde:	4505                	li	a0,1
     ...
     cf0:	8ec50513          	addi	a0,a0,-1812 # 65d8 <malloc+0x5dc>
     cf4:	00005097          	auipc	ra,0x5
     cf8:	24a080e7          	jalr	586(ra) # 5f3e <printf>
      exit(1);
     cfc:	4505                	li	a0,1
     ...
     d0e:	8e650513          	addi	a0,a0,-1818 # 65f0 <malloc+0x5f4>
     d12:	00005097          	auipc	ra,0x5
     d16:	22c080e7          	jalr	556(ra) # 5f3e <printf>
      exit(1);
     d1a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	8f250513          	addi	a0,a0,-1806 # 6618 <malloc+0x61c>
     d2e:	00005097          	auipc	ra,0x5
     d32:	210080e7          	jalr	528(ra) # 5f3e <printf>
    exit(1);
     d36:	4505                	li	a0,1
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	8dc50513          	addi	a0,a0,-1828 # 6630 <malloc+0x634>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	8f458593          	addi	a1,a1,-1804 # 6660 <malloc+0x664>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	8a850513          	addi	a0,a0,-1880 # 6630 <malloc+0x634>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	89250513          	addi	a0,a0,-1902 # 6630 <malloc+0x634>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	87c50513          	addi	a0,a0,-1924 # 6630 <malloc+0x634>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	8e058593          	addi	a1,a1,-1824 # 66a8 <malloc+0x6ac>
  ...
  unlink("unlinkread");
     ...
     e34:	80050513          	addi	a0,a0,-2048 # 6630 <malloc+0x634>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	7f050513          	addi	a0,a0,2032 # 6640 <malloc+0x644>
     e58:	00005097          	auipc	ra,0x5
     e5c:	0e6080e7          	jalr	230(ra) # 5f3e <printf>
    exit(1);
     e60:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	7fc50513          	addi	a0,a0,2044 # 6668 <malloc+0x66c>
     e74:	00005097          	auipc	ra,0x5
     e78:	0ca080e7          	jalr	202(ra) # 5f3e <printf>
    exit(1);
     e7c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	80050513          	addi	a0,a0,-2048 # 6688 <malloc+0x68c>
     e90:	00005097          	auipc	ra,0x5
     e94:	0ae080e7          	jalr	174(ra) # 5f3e <printf>
    exit(1);
     e98:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	80c50513          	addi	a0,a0,-2036 # 66b0 <malloc+0x6b4>
     eac:	00005097          	auipc	ra,0x5
     eb0:	092080e7          	jalr	146(ra) # 5f3e <printf>
    exit(1);
     eb4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	81050513          	addi	a0,a0,-2032 # 66d0 <malloc+0x6d4>
     ec8:	00005097          	auipc	ra,0x5
     ecc:	076080e7          	jalr	118(ra) # 5f3e <printf>
    exit(1);
     ed0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	81450513          	addi	a0,a0,-2028 # 66f0 <malloc+0x6f4>
     ee4:	00005097          	auipc	ra,0x5
     ee8:	05a080e7          	jalr	90(ra) # 5f3e <printf>
    exit(1);
     eec:	4505                	li	a0,1
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	72058593          	addi	a1,a1,1824 # 6660 <malloc+0x664>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	7b858593          	addi	a1,a1,1976 # 6718 <malloc+0x71c>
     f68:	00005517          	auipc	a0,0x5
     f6c:	7a850513          	addi	a0,a0,1960 # 6710 <malloc+0x714>
  ...
  unlink("lf1");
     ...
     f80:	79450513          	addi	a0,a0,1940 # 6710 <malloc+0x714>
     f84:	00005097          	auipc	ra,0x5
     f88:	c92080e7          	jalr	-878(ra) # 5c16 <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00005517          	auipc	a0,0x5
     f92:	78250513          	addi	a0,a0,1922 # 6710 <malloc+0x714>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	77450513          	addi	a0,a0,1908 # 6718 <malloc+0x71c>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	73c58593          	addi	a1,a1,1852 # 6718 <malloc+0x71c>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	72650513          	addi	a0,a0,1830 # 6718 <malloc+0x71c>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c1c080e7          	jalr	-996(ra) # 5c16 <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00005597          	auipc	a1,0x5
    1006:	70e58593          	addi	a1,a1,1806 # 6710 <malloc+0x714>
    100a:	00005517          	auipc	a0,0x5
    100e:	70e50513          	addi	a0,a0,1806 # 6718 <malloc+0x71c>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	6f258593          	addi	a1,a1,1778 # 6710 <malloc+0x714>
    1026:	00005517          	auipc	a0,0x5
    102a:	7fa50513          	addi	a0,a0,2042 # 6820 <malloc+0x824>
    ...
    104c:	6d850513          	addi	a0,a0,1752 # 6720 <malloc+0x724>
    1050:	00005097          	auipc	ra,0x5
    1054:	eee080e7          	jalr	-274(ra) # 5f3e <printf>
    exit(1);
    1058:	4505                	li	a0,1
    ...
    1068:	6d450513          	addi	a0,a0,1748 # 6738 <malloc+0x73c>
    106c:	00005097          	auipc	ra,0x5
    1070:	ed2080e7          	jalr	-302(ra) # 5f3e <printf>
    exit(1);
    1074:	4505                	li	a0,1
    ...
    1084:	6d050513          	addi	a0,a0,1744 # 6750 <malloc+0x754>
    1088:	00005097          	auipc	ra,0x5
    108c:	eb6080e7          	jalr	-330(ra) # 5f3e <printf>
    exit(1);
    1090:	4505                	li	a0,1
    ...
    10a0:	6d450513          	addi	a0,a0,1748 # 6770 <malloc+0x774>
    10a4:	00005097          	auipc	ra,0x5
    10a8:	e9a080e7          	jalr	-358(ra) # 5f3e <printf>
    exit(1);
    10ac:	4505                	li	a0,1
    ...
    10bc:	6e850513          	addi	a0,a0,1768 # 67a0 <malloc+0x7a4>
    10c0:	00005097          	auipc	ra,0x5
    10c4:	e7e080e7          	jalr	-386(ra) # 5f3e <printf>
    exit(1);
    10c8:	4505                	li	a0,1
    ...
    10d8:	6e450513          	addi	a0,a0,1764 # 67b8 <malloc+0x7bc>
    10dc:	00005097          	auipc	ra,0x5
    10e0:	e62080e7          	jalr	-414(ra) # 5f3e <printf>
    exit(1);
    10e4:	4505                	li	a0,1
    ...
    10f4:	6e050513          	addi	a0,a0,1760 # 67d0 <malloc+0x7d4>
    10f8:	00005097          	auipc	ra,0x5
    10fc:	e46080e7          	jalr	-442(ra) # 5f3e <printf>
    exit(1);
    1100:	4505                	li	a0,1
    ...
    1110:	6ec50513          	addi	a0,a0,1772 # 67f8 <malloc+0x7fc>
    1114:	00005097          	auipc	ra,0x5
    1118:	e2a080e7          	jalr	-470(ra) # 5f3e <printf>
    exit(1);
    111c:	4505                	li	a0,1
    ...
    112c:	70050513          	addi	a0,a0,1792 # 6828 <malloc+0x82c>
    1130:	00005097          	auipc	ra,0x5
    1134:	e0e080e7          	jalr	-498(ra) # 5f3e <printf>
    exit(1);
    1138:	4505                	li	a0,1
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	6ee98993          	addi	s3,s3,1774 # 6848 <malloc+0x84c>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	6c250513          	addi	a0,a0,1730 # 6858 <malloc+0x85c>
    119e:	00005097          	auipc	ra,0x5
    11a2:	da0080e7          	jalr	-608(ra) # 5f3e <printf>
      exit(1);
    11a6:	4505                	li	a0,1
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	67ca0a13          	addi	s4,s4,1660 # 6878 <malloc+0x87c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	62a50513          	addi	a0,a0,1578 # 6878 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	5c250513          	addi	a0,a0,1474 # 6880 <malloc+0x884>
    12c6:	00005097          	auipc	ra,0x5
    12ca:	c78080e7          	jalr	-904(ra) # 5f3e <printf>
    exit(1);
    12ce:	4505                	li	a0,1
    ...
    12e2:	5c250513          	addi	a0,a0,1474 # 68a0 <malloc+0x8a4>
    12e6:	00005097          	auipc	ra,0x5
    12ea:	c58080e7          	jalr	-936(ra) # 5f3e <printf>
      exit(1);
    12ee:	4505                	li	a0,1
    ...
    12fe:	5c650513          	addi	a0,a0,1478 # 68c0 <malloc+0x8c4>
    1302:	00005097          	auipc	ra,0x5
    1306:	c3c080e7          	jalr	-964(ra) # 5f3e <printf>
      exit(1);
    130a:	4505                	li	a0,1
...
000000000000134c <badarg>:
{
    ...
    136a:	dd298993          	addi	s3,s3,-558 # 6138 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	72878793          	addi	a5,a5,1832 # 7b18 <malloc+0x1b1c>
  ...
  if(pid == 0){
    ...
    1450:	0ec78793          	addi	a5,a5,236 # 8538 <malloc+0x253c>
    ...
    1474:	cc850513          	addi	a0,a0,-824 # 6138 <malloc+0x13c>
    ...
    148c:	4e050513          	addi	a0,a0,1248 # 6968 <malloc+0x96c>
    1490:	00005097          	auipc	ra,0x5
    1494:	aae080e7          	jalr	-1362(ra) # 5f3e <printf>
      exit(1);
    1498:	4505                	li	a0,1
    ...
    14ac:	43850513          	addi	a0,a0,1080 # 68e0 <malloc+0x8e4>
    14b0:	00005097          	auipc	ra,0x5
    14b4:	a8e080e7          	jalr	-1394(ra) # 5f3e <printf>
    exit(1);
    14b8:	4505                	li	a0,1
    ...
    14cc:	43850513          	addi	a0,a0,1080 # 6900 <malloc+0x904>
    14d0:	00005097          	auipc	ra,0x5
    14d4:	a6e080e7          	jalr	-1426(ra) # 5f3e <printf>
    exit(1);
    14d8:	4505                	li	a0,1
    ...
    14ee:	43650513          	addi	a0,a0,1078 # 6920 <malloc+0x924>
    14f2:	00005097          	auipc	ra,0x5
    14f6:	a4c080e7          	jalr	-1460(ra) # 5f3e <printf>
    exit(1);
    14fa:	4505                	li	a0,1
    ...
    150e:	43e50513          	addi	a0,a0,1086 # 6948 <malloc+0x94c>
    1512:	00005097          	auipc	ra,0x5
    1516:	a2c080e7          	jalr	-1492(ra) # 5f3e <printf>
    exit(1);
    151a:	4505                	li	a0,1
    ...
    1528:	8a450513          	addi	a0,a0,-1884 # 6dc8 <malloc+0xdcc>
    152c:	00005097          	auipc	ra,0x5
    1530:	a12080e7          	jalr	-1518(ra) # 5f3e <printf>
    exit(1);
    1534:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1572:	42250513          	addi	a0,a0,1058 # 6990 <malloc+0x994>
    1576:	00005097          	auipc	ra,0x5
    157a:	9c8080e7          	jalr	-1592(ra) # 5f3e <printf>
    exit(1);
    157e:	4505                	li	a0,1
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a4:	bf050513          	addi	a0,a0,-1040 # 6190 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    15ce:	bc6a0a13          	addi	s4,s4,-1082 # 6190 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	41ea8a93          	addi	s5,s5,1054 # 69f0 <malloc+0x9f4>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    1646:	37e50513          	addi	a0,a0,894 # 69c0 <malloc+0x9c4>
    164a:	00005097          	auipc	ra,0x5
    164e:	8f4080e7          	jalr	-1804(ra) # 5f3e <printf>
    exit(1);
    1652:	4505                	li	a0,1
    ...
    1662:	37a50513          	addi	a0,a0,890 # 69d8 <malloc+0x9dc>
    1666:	00005097          	auipc	ra,0x5
    166a:	8d8080e7          	jalr	-1832(ra) # 5f3e <printf>
        exit(1);
    166e:	4505                	li	a0,1
    ...
    1680:	38450513          	addi	a0,a0,900 # 6a00 <malloc+0xa04>
    1684:	00005097          	auipc	ra,0x5
    1688:	8ba080e7          	jalr	-1862(ra) # 5f3e <printf>
        exit(1);
    168c:	4505                	li	a0,1
    ...
    169e:	af6a0a13          	addi	s4,s4,-1290 # 6190 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    16a2:	00005a97          	auipc	s5,0x5
    16a6:	37ea8a93          	addi	s5,s5,894 # 6a20 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f0:	aa450513          	addi	a0,a0,-1372 # 6190 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    170e:	2ce50513          	addi	a0,a0,718 # 69d8 <malloc+0x9dc>
    1712:	00005097          	auipc	ra,0x5
    1716:	82c080e7          	jalr	-2004(ra) # 5f3e <printf>
      exit(1);
    171a:	4505                	li	a0,1
    ...
    172c:	30050513          	addi	a0,a0,768 # 6a28 <malloc+0xa2c>
    1730:	00005097          	auipc	ra,0x5
    1734:	80e080e7          	jalr	-2034(ra) # 5f3e <printf>
      exit(1);
    1738:	4505                	li	a0,1
...
0000000000001742 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1754:	9e878793          	addi	a5,a5,-1560 # 6138 <malloc+0x13c>
    1758:	fcf43023          	sd	a5,-64(s0)
    175c:	00005797          	auipc	a5,0x5
    1760:	2ec78793          	addi	a5,a5,748 # 6a48 <malloc+0xa4c>
    1764:	fcf43423          	sd	a5,-56(s0)
    1768:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176c:	00005517          	auipc	a0,0x5
    1770:	2e450513          	addi	a0,a0,740 # 6a50 <malloc+0xa54>
  ...
  if(pid == 0) {
    ...
    179e:	2b650513          	addi	a0,a0,694 # 6a50 <malloc+0xa54>
    ...
    17ba:	2ba50513          	addi	a0,a0,698 # 6a70 <malloc+0xa74>
    17be:	00004097          	auipc	ra,0x4
    17c2:	780080e7          	jalr	1920(ra) # 5f3e <printf>
      exit(1);
    17c6:	4505                	li	a0,1
    ...
    17d6:	1ee50513          	addi	a0,a0,494 # 69c0 <malloc+0x9c4>
    17da:	00004097          	auipc	ra,0x4
    17de:	764080e7          	jalr	1892(ra) # 5f3e <printf>
     exit(1);
    17e2:	4505                	li	a0,1
    ...
    17f2:	26a50513          	addi	a0,a0,618 # 6a58 <malloc+0xa5c>
    17f6:	00004097          	auipc	ra,0x4
    17fa:	748080e7          	jalr	1864(ra) # 5f3e <printf>
      exit(1);
    17fe:	4505                	li	a0,1
    ...
    1810:	92c50513          	addi	a0,a0,-1748 # 6138 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    1844:	24050513          	addi	a0,a0,576 # 6a80 <malloc+0xa84>
    1848:	00004097          	auipc	ra,0x4
    184c:	6f6080e7          	jalr	1782(ra) # 5f3e <printf>
      exit(1);
    1850:	4505                	li	a0,1
    ...
    1860:	23c50513          	addi	a0,a0,572 # 6a98 <malloc+0xa9c>
    1864:	00004097          	auipc	ra,0x4
    1868:	6da080e7          	jalr	1754(ra) # 5f3e <printf>
    186c:	b7d1                	j	1830 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    186e:	4581                	li	a1,0
    1870:	00005517          	auipc	a0,0x5
    1874:	1e050513          	addi	a0,a0,480 # 6a50 <malloc+0xa54>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189e:	c6e50513          	addi	a0,a0,-914 # 6508 <malloc+0x50c>
    18a2:	00004097          	auipc	ra,0x4
    18a6:	69c080e7          	jalr	1692(ra) # 5f3e <printf>
    exit(1);
    18aa:	4505                	li	a0,1
    ...
    18ba:	12250513          	addi	a0,a0,290 # 69d8 <malloc+0x9dc>
    18be:	00004097          	auipc	ra,0x4
    18c2:	680080e7          	jalr	1664(ra) # 5f3e <printf>
    exit(1);
    18c6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18d4:	18050513          	addi	a0,a0,384 # 6a50 <malloc+0xa54>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fe:	1b650513          	addi	a0,a0,438 # 6ab0 <malloc+0xab4>
    1902:	00004097          	auipc	ra,0x4
    1906:	63c080e7          	jalr	1596(ra) # 5f3e <printf>
    exit(1);
    190a:	4505                	li	a0,1
...
000000000000191e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19c0:	10c50513          	addi	a0,a0,268 # 6ac8 <malloc+0xacc>
    19c4:	00004097          	auipc	ra,0x4
    19c8:	57a080e7          	jalr	1402(ra) # 5f3e <printf>
    exit(1);
    19cc:	4505                	li	a0,1
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a46:	09e50513          	addi	a0,a0,158 # 6ae0 <malloc+0xae4>
    1a4a:	00004097          	auipc	ra,0x4
    1a4e:	4f4080e7          	jalr	1268(ra) # 5f3e <printf>
        exit(1);
    1a52:	4505                	li	a0,1
    ...
    1a62:	09a50513          	addi	a0,a0,154 # 6af8 <malloc+0xafc>
    1a66:	00004097          	auipc	ra,0x4
    1a6a:	4d8080e7          	jalr	1240(ra) # 5f3e <printf>
}
    ...
    1a94:	08050513          	addi	a0,a0,128 # 6b10 <malloc+0xb14>
    1a98:	00004097          	auipc	ra,0x4
    1a9c:	4a6080e7          	jalr	1190(ra) # 5f3e <printf>
      exit(1);
    1aa0:	4505                	li	a0,1
    ...
    1ad4:	06050513          	addi	a0,a0,96 # 6b30 <malloc+0xb34>
    1ad8:	00004097          	auipc	ra,0x4
    1adc:	466080e7          	jalr	1126(ra) # 5f3e <printf>
    exit(1);
    1ae0:	4505                	li	a0,1
...
0000000000001aea <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b46:	e7e50513          	addi	a0,a0,-386 # 69c0 <malloc+0x9c4>
    1b4a:	00004097          	auipc	ra,0x4
    1b4e:	3f4080e7          	jalr	1012(ra) # 5f3e <printf>
      exit(1);
    1b52:	4505                	li	a0,1
    ...
    1b62:	fea50513          	addi	a0,a0,-22 # 6b48 <malloc+0xb4c>
    1b66:	00004097          	auipc	ra,0x4
    1b6a:	3d8080e7          	jalr	984(ra) # 5f3e <printf>
        exit(1);
    1b6e:	4505                	li	a0,1
    ...
    1b7e:	fe650513          	addi	a0,a0,-26 # 6b60 <malloc+0xb64>
    1b82:	00004097          	auipc	ra,0x4
    1b86:	3bc080e7          	jalr	956(ra) # 5f3e <printf>
        exit(1);
    1b8a:	4505                	li	a0,1
...
0000000000001b9e <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf6:	dce50513          	addi	a0,a0,-562 # 69c0 <malloc+0x9c4>
    1bfa:	00004097          	auipc	ra,0x4
    1bfe:	344080e7          	jalr	836(ra) # 5f3e <printf>
      exit(1);
    1c02:	4505                	li	a0,1
    ...
    1c1a:	daa50513          	addi	a0,a0,-598 # 69c0 <malloc+0x9c4>
    1c1e:	00004097          	auipc	ra,0x4
    1c22:	320080e7          	jalr	800(ra) # 5f3e <printf>
        exit(1);
    1c26:	4505                	li	a0,1
...
0000000000001c38 <forkfork>:
{
    ...
    1c94:	ef050513          	addi	a0,a0,-272 # 6b80 <malloc+0xb84>
    1c98:	00004097          	auipc	ra,0x4
    1c9c:	2a6080e7          	jalr	678(ra) # 5f3e <printf>
      exit(1);
    1ca0:	4505                	li	a0,1
    ...
    1ca6:	f24080e7          	jalr	-220(ra) # 5bc6 <exit>
{
    ...
    1cec:	ea850513          	addi	a0,a0,-344 # 6b90 <malloc+0xb94>
    1cf0:	00004097          	auipc	ra,0x4
    1cf4:	24e080e7          	jalr	590(ra) # 5f3e <printf>
      exit(1);
    1cf8:	4505                	li	a0,1
...
0000000000001d02 <reparent2>:
{
  ...
  exit(0);
    ...
    1d3a:	09250513          	addi	a0,a0,146 # 6dc8 <malloc+0xdcc>
    1d3e:	00004097          	auipc	ra,0x4
    1d42:	200080e7          	jalr	512(ra) # 5f3e <printf>
      exit(1);
    1d46:	4505                	li	a0,1
...
0000000000001d6a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd8:	ff450513          	addi	a0,a0,-12 # 6dc8 <malloc+0xdcc>
    1ddc:	00004097          	auipc	ra,0x4
    1de0:	162080e7          	jalr	354(ra) # 5f3e <printf>
      exit(1);
    1de4:	4505                	li	a0,1
    ...
    1e04:	c5850513          	addi	a0,a0,-936 # 6a58 <malloc+0xa5c>
    1e08:	00004097          	auipc	ra,0x4
    1e0c:	136080e7          	jalr	310(ra) # 5f3e <printf>
          exit(1);
    1e10:	4505                	li	a0,1
    ...
    1e76:	d3e50513          	addi	a0,a0,-706 # 6bb0 <malloc+0xbb4>
    1e7a:	00004097          	auipc	ra,0x4
    1e7e:	0c4080e7          	jalr	196(ra) # 5f3e <printf>
            exit(1);
    1e82:	4505                	li	a0,1
    ...
    1eaa:	d2250513          	addi	a0,a0,-734 # 6bc8 <malloc+0xbcc>
    1eae:	00004097          	auipc	ra,0x4
    1eb2:	090080e7          	jalr	144(ra) # 5f3e <printf>
        exit(1);
    1eb6:	4505                	li	a0,1
    ...
    1f10:	ce450513          	addi	a0,a0,-796 # 6bf0 <malloc+0xbf4>
    1f14:	00004097          	auipc	ra,0x4
    1f18:	02a080e7          	jalr	42(ra) # 5f3e <printf>
        exit(1);
    1f1c:	4505                	li	a0,1
...
0000000000001f90 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb0:	1fc50513          	addi	a0,a0,508 # 61a8 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fec:	1c0a8a93          	addi	s5,s5,448 # 61a8 <malloc+0x1ac>
      link("cat", "x");
    1ff0:	00005b97          	auipc	s7,0x5
    1ff4:	c28b8b93          	addi	s7,s7,-984 # 6c18 <malloc+0xc1c>
    1ff8:	a825                	j	2030 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ffa:	85a6                	mv	a1,s1
    1ffc:	00005517          	auipc	a0,0x5
    2000:	9c450513          	addi	a0,a0,-1596 # 69c0 <malloc+0x9c4>
    2004:	00004097          	auipc	ra,0x4
    2008:	f3a080e7          	jalr	-198(ra) # 5f3e <printf>
    exit(1);
    200c:	4505                	li	a0,1
...
0000000000002092 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20c2:	b7a50513          	addi	a0,a0,-1158 # 6c38 <malloc+0xc3c>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	e78080e7          	jalr	-392(ra) # 5f3e <printf>
    exit(1);
    20ce:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    2124:	b0050513          	addi	a0,a0,-1280 # 6c20 <malloc+0xc24>
    2128:	00004097          	auipc	ra,0x4
    212c:	e16080e7          	jalr	-490(ra) # 5f3e <printf>
    exit(1);
    2130:	4505                	li	a0,1
    ...
    2140:	b2450513          	addi	a0,a0,-1244 # 6c60 <malloc+0xc64>
    2144:	00004097          	auipc	ra,0x4
    2148:	dfa080e7          	jalr	-518(ra) # 5f3e <printf>
      exit(1);
    214c:	4505                	li	a0,1
    ...
    215c:	b2050513          	addi	a0,a0,-1248 # 6c78 <malloc+0xc7c>
    2160:	00004097          	auipc	ra,0x4
    2164:	dde080e7          	jalr	-546(ra) # 5f3e <printf>
    exit(1);
    2168:	4505                	li	a0,1
...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21dc:	7e850513          	addi	a0,a0,2024 # 69c0 <malloc+0x9c4>
    21e0:	00004097          	auipc	ra,0x4
    21e4:	d5e080e7          	jalr	-674(ra) # 5f3e <printf>
      exit(1);
    21e8:	4505                	li	a0,1
    ...
    21fe:	a9650513          	addi	a0,a0,-1386 # 6c90 <malloc+0xc94>
    2202:	00004097          	auipc	ra,0x4
    2206:	d3c080e7          	jalr	-708(ra) # 5f3e <printf>
      exit(1);
    220a:	4505                	li	a0,1
...
000000000000221e <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2280:	74450513          	addi	a0,a0,1860 # 69c0 <malloc+0x9c4>
    2284:	00004097          	auipc	ra,0x4
    2288:	cba080e7          	jalr	-838(ra) # 5f3e <printf>
      exit(1);
    228c:	4505                	li	a0,1
    ...
    22ac:	a0850513          	addi	a0,a0,-1528 # 6cb0 <malloc+0xcb4>
    22b0:	00004097          	auipc	ra,0x4
    22b4:	c8e080e7          	jalr	-882(ra) # 5f3e <printf>
      exit(1);
    22b8:	4505                	li	a0,1
...
00000000000022cc <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22dc:	9f050513          	addi	a0,a0,-1552 # 6cc8 <malloc+0xccc>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230e:	9be50513          	addi	a0,a0,-1602 # 6cc8 <malloc+0xccc>
  ...
  close(fd);
    ...
    2344:	99870713          	addi	a4,a4,-1640 # 6cd8 <malloc+0xcdc>
    ...
    2398:	a2450513          	addi	a0,a0,-1500 # 6db8 <malloc+0xdbc>
    239c:	00004097          	auipc	ra,0x4
    23a0:	ba2080e7          	jalr	-1118(ra) # 5f3e <printf>
    exit(1);
    23a4:	4505                	li	a0,1
    ...
    23bc:	a2050513          	addi	a0,a0,-1504 # 6dd8 <malloc+0xddc>
    23c0:	00004097          	auipc	ra,0x4
    23c4:	b7e080e7          	jalr	-1154(ra) # 5f3e <printf>
    exit(1);
    23c8:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    241a:	9e250513          	addi	a0,a0,-1566 # 6df8 <malloc+0xdfc>
    241e:	00004097          	auipc	ra,0x4
    2422:	b20080e7          	jalr	-1248(ra) # 5f3e <printf>
    exit(1);
    2426:	4505                	li	a0,1
    ...
    2436:	58e50513          	addi	a0,a0,1422 # 69c0 <malloc+0x9c4>
    243a:	00004097          	auipc	ra,0x4
    243e:	b04080e7          	jalr	-1276(ra) # 5f3e <printf>
    exit(1);
    2442:	4505                	li	a0,1
...
0000000000002456 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a4:	52050513          	addi	a0,a0,1312 # 69c0 <malloc+0x9c4>
    24a8:	00004097          	auipc	ra,0x4
    24ac:	a96080e7          	jalr	-1386(ra) # 5f3e <printf>
    exit(1);
    24b0:	4505                	li	a0,1
...
00000000000024c4 <manywrites>:
{
  ...
  exit(0);
    ...
    2520:	8ac50513          	addi	a0,a0,-1876 # 6dc8 <malloc+0xdcc>
    2524:	00004097          	auipc	ra,0x4
    2528:	a1a080e7          	jalr	-1510(ra) # 5f3e <printf>
      exit(1);
    252c:	4505                	li	a0,1
    ...
    25d0:	85450513          	addi	a0,a0,-1964 # 6e20 <malloc+0xe24>
    25d4:	00004097          	auipc	ra,0x4
    25d8:	96a080e7          	jalr	-1686(ra) # 5f3e <printf>
            exit(1);
    25dc:	4505                	li	a0,1
    ...
    25f0:	c1c50513          	addi	a0,a0,-996 # 6208 <malloc+0x20c>
    25f4:	00004097          	auipc	ra,0x4
    25f8:	94a080e7          	jalr	-1718(ra) # 5f3e <printf>
            exit(1);
    25fc:	4505                	li	a0,1
...
000000000000260e <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2688:	49478793          	addi	a5,a5,1172 # 7b18 <malloc+0x1b1c>
  ...
  if(ret != -1){
    ...
    26ca:	77250513          	addi	a0,a0,1906 # 6e38 <malloc+0xe3c>
    26ce:	00004097          	auipc	ra,0x4
    26d2:	870080e7          	jalr	-1936(ra) # 5f3e <printf>
    exit(1);
    26d6:	4505                	li	a0,1
    ...
    26e8:	1fc50513          	addi	a0,a0,508 # 68e0 <malloc+0x8e4>
    26ec:	00004097          	auipc	ra,0x4
    26f0:	852080e7          	jalr	-1966(ra) # 5f3e <printf>
    exit(1);
    26f4:	4505                	li	a0,1
    ...
    2706:	1fe50513          	addi	a0,a0,510 # 6900 <malloc+0x904>
    270a:	00004097          	auipc	ra,0x4
    270e:	834080e7          	jalr	-1996(ra) # 5f3e <printf>
    exit(1);
    2712:	4505                	li	a0,1
    ...
    2726:	1fe50513          	addi	a0,a0,510 # 6920 <malloc+0x924>
    272a:	00004097          	auipc	ra,0x4
    272e:	814080e7          	jalr	-2028(ra) # 5f3e <printf>
    exit(1);
    2732:	4505                	li	a0,1
    ...
    2744:	20850513          	addi	a0,a0,520 # 6948 <malloc+0x94c>
    2748:	00003097          	auipc	ra,0x3
    274c:	7f6080e7          	jalr	2038(ra) # 5f3e <printf>
    exit(1);
    2750:	4505                	li	a0,1
...
000000000000275a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2790:	6ec50513          	addi	a0,a0,1772 # 6e78 <malloc+0xe7c>
  ...
  if(n >= 0){
    ...
    27c2:	6da50513          	addi	a0,a0,1754 # 6e98 <malloc+0xe9c>
    27c6:	00003097          	auipc	ra,0x3
    27ca:	778080e7          	jalr	1912(ra) # 5f3e <printf>
    exit(1);
    27ce:	4505                	li	a0,1
    ...
    27dc:	66850513          	addi	a0,a0,1640 # 6e40 <malloc+0xe44>
    27e0:	00003097          	auipc	ra,0x3
    27e4:	75e080e7          	jalr	1886(ra) # 5f3e <printf>
    exit(1);
    27e8:	4505                	li	a0,1
    ...
    27f6:	66650513          	addi	a0,a0,1638 # 6e58 <malloc+0xe5c>
    27fa:	00003097          	auipc	ra,0x3
    27fe:	744080e7          	jalr	1860(ra) # 5f3e <printf>
    exit(1);
    2802:	4505                	li	a0,1
    ...
    2810:	67450513          	addi	a0,a0,1652 # 6e80 <malloc+0xe84>
    2814:	00003097          	auipc	ra,0x3
    2818:	72a080e7          	jalr	1834(ra) # 5f3e <printf>
    exit(1);
    281c:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2834:	64850513          	addi	a0,a0,1608 # 6e78 <malloc+0xe7c>
    2838:	00003097          	auipc	ra,0x3
    283c:	3de080e7          	jalr	990(ra) # 5c16 <unlink>
  fd = open("README", O_RDONLY);
    2840:	4581                	li	a1,0
    2842:	00004517          	auipc	a0,0x4
    2846:	ace50513          	addi	a0,a0,-1330 # 6310 <malloc+0x314>
  ...
  if(n >= 0){
    ...
    2870:	65c50513          	addi	a0,a0,1628 # 6ec8 <malloc+0xecc>
    2874:	00003097          	auipc	ra,0x3
    2878:	6ca080e7          	jalr	1738(ra) # 5f3e <printf>
    exit(1);
    287c:	4505                	li	a0,1
    ...
    288a:	5fa50513          	addi	a0,a0,1530 # 6e80 <malloc+0xe84>
    288e:	00003097          	auipc	ra,0x3
    2892:	6b0080e7          	jalr	1712(ra) # 5f3e <printf>
    exit(1);
    2896:	4505                	li	a0,1
...
00000000000028b4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    290a:	5ea50513          	addi	a0,a0,1514 # 6ef0 <malloc+0xef4>
    290e:	00003097          	auipc	ra,0x3
    2912:	630080e7          	jalr	1584(ra) # 5f3e <printf>
    exit(1);
    2916:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    295c:	5b850513          	addi	a0,a0,1464 # 6f10 <malloc+0xf14>
    2960:	00003097          	auipc	ra,0x3
    2964:	5de080e7          	jalr	1502(ra) # 5f3e <printf>
    exit(1);
    2968:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29c0:	5b450513          	addi	a0,a0,1460 # 6f70 <malloc+0xf74>
    29c4:	00003097          	auipc	ra,0x3
    29c8:	57a080e7          	jalr	1402(ra) # 5f3e <printf>
    exit(1);
    29cc:	4505                	li	a0,1
    ...
    29e2:	55250513          	addi	a0,a0,1362 # 6f30 <malloc+0xf34>
    29e6:	00003097          	auipc	ra,0x3
    29ea:	558080e7          	jalr	1368(ra) # 5f3e <printf>
      exit(1);
    29ee:	4505                	li	a0,1
    ...
    29fe:	55650513          	addi	a0,a0,1366 # 6f50 <malloc+0xf54>
    2a02:	00003097          	auipc	ra,0x3
    2a06:	53c080e7          	jalr	1340(ra) # 5f3e <printf>
    exit(1);
    2a0a:	4505                	li	a0,1
...
0000000000002a3a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b48:	44c50513          	addi	a0,a0,1100 # 6f90 <malloc+0xf94>
    2b4c:	00003097          	auipc	ra,0x3
    2b50:	3f2080e7          	jalr	1010(ra) # 5f3e <printf>
    exit(1);
    2b54:	4505                	li	a0,1
    ...
    2b64:	47850513          	addi	a0,a0,1144 # 6fd8 <malloc+0xfdc>
    2b68:	00003097          	auipc	ra,0x3
    2b6c:	3d6080e7          	jalr	982(ra) # 5f3e <printf>
    exit(1);
    2b70:	4505                	li	a0,1
    ...
    2b84:	47850513          	addi	a0,a0,1144 # 6ff8 <malloc+0xffc>
    2b88:	00003097          	auipc	ra,0x3
    2b8c:	3b6080e7          	jalr	950(ra) # 5f3e <printf>
    exit(1);
    2b90:	4505                	li	a0,1
    ...
    2ba4:	49850513          	addi	a0,a0,1176 # 7038 <malloc+0x103c>
    2ba8:	00003097          	auipc	ra,0x3
    2bac:	396080e7          	jalr	918(ra) # 5f3e <printf>
    exit(1);
    2bb0:	4505                	li	a0,1
    ...
    2bc0:	4ac50513          	addi	a0,a0,1196 # 7068 <malloc+0x106c>
    2bc4:	00003097          	auipc	ra,0x3
    2bc8:	37a080e7          	jalr	890(ra) # 5f3e <printf>
    exit(1);
    2bcc:	4505                	li	a0,1
    ...
    2be0:	4c450513          	addi	a0,a0,1220 # 70a0 <malloc+0x10a4>
    2be4:	00003097          	auipc	ra,0x3
    2be8:	35a080e7          	jalr	858(ra) # 5f3e <printf>
    exit(1);
    2bec:	4505                	li	a0,1
...
0000000000002bf6 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c1a:	4b250513          	addi	a0,a0,1202 # 70c8 <malloc+0x10cc>
    2c1e:	00003097          	auipc	ra,0x3
    2c22:	fe8080e7          	jalr	-24(ra) # 5c06 <open>
    2c26:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c28:	00004517          	auipc	a0,0x4
    2c2c:	4a050513          	addi	a0,a0,1184 # 70c8 <malloc+0x10cc>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c80:	45450513          	addi	a0,a0,1108 # 70d0 <malloc+0x10d4>
    2c84:	00003097          	auipc	ra,0x3
    2c88:	2ba080e7          	jalr	698(ra) # 5f3e <printf>
    exit(1);
    2c8c:	4505                	li	a0,1
    ...
    2c9c:	45050513          	addi	a0,a0,1104 # 70e8 <malloc+0x10ec>
    2ca0:	00003097          	auipc	ra,0x3
    2ca4:	29e080e7          	jalr	670(ra) # 5f3e <printf>
    exit(1);
    2ca8:	4505                	li	a0,1
    ...
    2cb8:	e1450513          	addi	a0,a0,-492 # 6ac8 <malloc+0xacc>
    2cbc:	00003097          	auipc	ra,0x3
    2cc0:	282080e7          	jalr	642(ra) # 5f3e <printf>
    exit(1);
    2cc4:	4505                	li	a0,1
...
0000000000002cce <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce2:	42250513          	addi	a0,a0,1058 # 7100 <malloc+0x1104>
  ...
  close(fd);
    ...
    2d2a:	cb250513          	addi	a0,a0,-846 # 69d8 <malloc+0x9dc>
    2d2e:	00003097          	auipc	ra,0x3
    2d32:	210080e7          	jalr	528(ra) # 5f3e <printf>
    exit(1);
    2d36:	4505                	li	a0,1
...
0000000000002d40 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d78:	05450513          	addi	a0,a0,84 # 6dc8 <malloc+0xdcc>
    2d7c:	00003097          	auipc	ra,0x3
    2d80:	1c2080e7          	jalr	450(ra) # 5f3e <printf>
    exit(1);
    2d84:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dce:	ffe50513          	addi	a0,a0,-2 # 6dc8 <malloc+0xdcc>
    2dd2:	00003097          	auipc	ra,0x3
    2dd6:	16c080e7          	jalr	364(ra) # 5f3e <printf>
    exit(1);
    2dda:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e2e:	f9e50513          	addi	a0,a0,-98 # 6dc8 <malloc+0xdcc>
    2e32:	00003097          	auipc	ra,0x3
    2e36:	10c080e7          	jalr	268(ra) # 5f3e <printf>
    exit(1);
    2e3a:	4505                	li	a0,1
...
0000000000002f60 <execout>:
{
  ...
  exit(0);
    ...
    2fa2:	e2a50513          	addi	a0,a0,-470 # 6dc8 <malloc+0xdcc>
    2fa6:	00003097          	auipc	ra,0x3
    2faa:	f98080e7          	jalr	-104(ra) # 5f3e <printf>
      exit(1);
    2fae:	4505                	li	a0,1
    ...
    2ff6:	14650513          	addi	a0,a0,326 # 6138 <malloc+0x13c>
    2ffa:	faa43c23          	sd	a0,-72(s0)
    2ffe:	00003797          	auipc	a5,0x3
    3002:	1aa78793          	addi	a5,a5,426 # 61a8 <malloc+0x1ac>
...
0000000000003024 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3034:	2a850513          	addi	a0,a0,680 # 72d8 <malloc+0x12dc>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3046:	0ee50513          	addi	a0,a0,238 # 7130 <malloc+0x1134>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    305c:	13050513          	addi	a0,a0,304 # 7188 <malloc+0x118c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    307a:	18a50513          	addi	a0,a0,394 # 7200 <malloc+0x1204>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3096:	1de50513          	addi	a0,a0,478 # 7270 <malloc+0x1274>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a8:	22450513          	addi	a0,a0,548 # 72c8 <malloc+0x12cc>
  ...
  unlink("12345678901234");
    ...
    3126:	fe650513          	addi	a0,a0,-26 # 7108 <malloc+0x110c>
    312a:	00003097          	auipc	ra,0x3
    312e:	e14080e7          	jalr	-492(ra) # 5f3e <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    3142:	01250513          	addi	a0,a0,18 # 7150 <malloc+0x1154>
    3146:	00003097          	auipc	ra,0x3
    314a:	df8080e7          	jalr	-520(ra) # 5f3e <printf>
    exit(1);
    314e:	4505                	li	a0,1
    ...
    315e:	05e50513          	addi	a0,a0,94 # 71b8 <malloc+0x11bc>
    3162:	00003097          	auipc	ra,0x3
    3166:	ddc080e7          	jalr	-548(ra) # 5f3e <printf>
    exit(1);
    316a:	4505                	li	a0,1
    ...
    317a:	0ba50513          	addi	a0,a0,186 # 7230 <malloc+0x1234>
    317e:	00003097          	auipc	ra,0x3
    3182:	dc0080e7          	jalr	-576(ra) # 5f3e <printf>
    exit(1);
    3186:	4505                	li	a0,1
    ...
    3196:	0fe50513          	addi	a0,a0,254 # 7290 <malloc+0x1294>
    319a:	00003097          	auipc	ra,0x3
    319e:	da4080e7          	jalr	-604(ra) # 5f3e <printf>
    exit(1);
    31a2:	4505                	li	a0,1
    ...
    31b2:	13a50513          	addi	a0,a0,314 # 72e8 <malloc+0x12ec>
    31b6:	00003097          	auipc	ra,0x3
    31ba:	d88080e7          	jalr	-632(ra) # 5f3e <printf>
    exit(1);
    31be:	4505                	li	a0,1
...
00000000000031c8 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31fe:	12650513          	addi	a0,a0,294 # 7320 <malloc+0x1324>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3228:	10c50513          	addi	a0,a0,268 # 7330 <malloc+0x1334>
    322c:	00003097          	auipc	ra,0x3
    3230:	d12080e7          	jalr	-750(ra) # 5f3e <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b8:	06c50513          	addi	a0,a0,108 # 7320 <malloc+0x1324>
  ...
  unlink("diskfulldir");
    ...
    32cc:	05850513          	addi	a0,a0,88 # 7320 <malloc+0x1324>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33fa:	f5a50513          	addi	a0,a0,-166 # 7350 <malloc+0x1354>
    33fe:	00003097          	auipc	ra,0x3
    3402:	b40080e7          	jalr	-1216(ra) # 5f3e <printf>
...
0000000000003408 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3418:	f6c50513          	addi	a0,a0,-148 # 7380 <malloc+0x1384>
  ...
  if(chdir("iputdir") < 0){
    ...
    342c:	f5850513          	addi	a0,a0,-168 # 7380 <malloc+0x1384>
  ...
  if(unlink("../iputdir") < 0){
    ...
    3440:	f8450513          	addi	a0,a0,-124 # 73c0 <malloc+0x13c4>
  ...
  if(chdir("/") < 0){
    ...
    3454:	fa050513          	addi	a0,a0,-96 # 73f0 <malloc+0x13f4>
    ...
    3474:	f1850513          	addi	a0,a0,-232 # 7388 <malloc+0x138c>
    3478:	00003097          	auipc	ra,0x3
    347c:	ac6080e7          	jalr	-1338(ra) # 5f3e <printf>
    exit(1);
    3480:	4505                	li	a0,1
    ...
    3490:	f1450513          	addi	a0,a0,-236 # 73a0 <malloc+0x13a4>
    3494:	00003097          	auipc	ra,0x3
    3498:	aaa080e7          	jalr	-1366(ra) # 5f3e <printf>
    exit(1);
    349c:	4505                	li	a0,1
    ...
    34ac:	f2850513          	addi	a0,a0,-216 # 73d0 <malloc+0x13d4>
    34b0:	00003097          	auipc	ra,0x3
    34b4:	a8e080e7          	jalr	-1394(ra) # 5f3e <printf>
    exit(1);
    34b8:	4505                	li	a0,1
    ...
    34c8:	f3450513          	addi	a0,a0,-204 # 73f8 <malloc+0x13fc>
    34cc:	00003097          	auipc	ra,0x3
    34d0:	a72080e7          	jalr	-1422(ra) # 5f3e <printf>
    exit(1);
    34d4:	4505                	li	a0,1
...
00000000000034de <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34fc:	e8850513          	addi	a0,a0,-376 # 7380 <malloc+0x1384>
    ...
    3510:	e7450513          	addi	a0,a0,-396 # 7380 <malloc+0x1384>
    ...
    3524:	ea050513          	addi	a0,a0,-352 # 73c0 <malloc+0x13c4>
    ...
    3544:	48050513          	addi	a0,a0,1152 # 69c0 <malloc+0x9c4>
    3548:	00003097          	auipc	ra,0x3
    354c:	9f6080e7          	jalr	-1546(ra) # 5f3e <printf>
    exit(1);
    3550:	4505                	li	a0,1
    ...
    3560:	e2c50513          	addi	a0,a0,-468 # 7388 <malloc+0x138c>
    3564:	00003097          	auipc	ra,0x3
    3568:	9da080e7          	jalr	-1574(ra) # 5f3e <printf>
      exit(1);
    356c:	4505                	li	a0,1
    ...
    357c:	e9850513          	addi	a0,a0,-360 # 7410 <malloc+0x1414>
    3580:	00003097          	auipc	ra,0x3
    3584:	9be080e7          	jalr	-1602(ra) # 5f3e <printf>
      exit(1);
    3588:	4505                	li	a0,1
    ...
    3598:	e3c50513          	addi	a0,a0,-452 # 73d0 <malloc+0x13d4>
    359c:	00003097          	auipc	ra,0x3
    35a0:	9a2080e7          	jalr	-1630(ra) # 5f3e <printf>
      exit(1);
    35a4:	4505                	li	a0,1
...
00000000000035c6 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d6:	e5650513          	addi	a0,a0,-426 # 7428 <malloc+0x142c>
  ...
  if(chdir("dir0") < 0){
    ...
    35ea:	e4250513          	addi	a0,a0,-446 # 7428 <malloc+0x142c>
  ...
  if(chdir("..") < 0){
    ...
    35fe:	e4e50513          	addi	a0,a0,-434 # 7448 <malloc+0x144c>
  ...
  if(unlink("dir0") < 0){
    ...
    3612:	e1a50513          	addi	a0,a0,-486 # 7428 <malloc+0x142c>
    ...
    3632:	d5a50513          	addi	a0,a0,-678 # 7388 <malloc+0x138c>
    3636:	00003097          	auipc	ra,0x3
    363a:	908080e7          	jalr	-1784(ra) # 5f3e <printf>
    exit(1);
    363e:	4505                	li	a0,1
    ...
    364e:	de650513          	addi	a0,a0,-538 # 7430 <malloc+0x1434>
    3652:	00003097          	auipc	ra,0x3
    3656:	8ec080e7          	jalr	-1812(ra) # 5f3e <printf>
    exit(1);
    365a:	4505                	li	a0,1
    ...
    366a:	dea50513          	addi	a0,a0,-534 # 7450 <malloc+0x1454>
    366e:	00003097          	auipc	ra,0x3
    3672:	8d0080e7          	jalr	-1840(ra) # 5f3e <printf>
    exit(1);
    3676:	4505                	li	a0,1
    ...
    3686:	de650513          	addi	a0,a0,-538 # 7468 <malloc+0x146c>
    368a:	00003097          	auipc	ra,0x3
    368e:	8b4080e7          	jalr	-1868(ra) # 5f3e <printf>
    exit(1);
    3692:	4505                	li	a0,1
...
000000000000369c <subdir>:
{
  ...
  unlink("ff");
    ...
    36ae:	f0650513          	addi	a0,a0,-250 # 75b0 <malloc+0x15b4>
    36b2:	00002097          	auipc	ra,0x2
    36b6:	564080e7          	jalr	1380(ra) # 5c16 <unlink>
  if(mkdir("dd") != 0){
    36ba:	00004517          	auipc	a0,0x4
    36be:	dc650513          	addi	a0,a0,-570 # 7480 <malloc+0x1484>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d6:	dce50513          	addi	a0,a0,-562 # 74a0 <malloc+0x14a4>
  ...
  write(fd, "ff", 2);
    ...
    36ee:	ec658593          	addi	a1,a1,-314 # 75b0 <malloc+0x15b4>
  ...
  if(unlink("dd") >= 0){
    ...
    3708:	d7c50513          	addi	a0,a0,-644 # 7480 <malloc+0x1484>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371c:	de050513          	addi	a0,a0,-544 # 74f8 <malloc+0x14fc>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3734:	df050513          	addi	a0,a0,-528 # 7520 <malloc+0x1524>
  ...
  write(fd, "FF", 2);
    ...
    374c:	e0858593          	addi	a1,a1,-504 # 7550 <malloc+0x1554>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3768:	df450513          	addi	a0,a0,-524 # 7558 <malloc+0x155c>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37b0:	dfc58593          	addi	a1,a1,-516 # 75a8 <malloc+0x15ac>
    37b4:	00004517          	auipc	a0,0x4
    37b8:	d6c50513          	addi	a0,a0,-660 # 7520 <malloc+0x1524>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37cc:	d5850513          	addi	a0,a0,-680 # 7520 <malloc+0x1524>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e2:	d4250513          	addi	a0,a0,-702 # 7520 <malloc+0x1524>
  ...
  if(chdir("dd") != 0){
    ...
    37f6:	c8e50513          	addi	a0,a0,-882 # 7480 <malloc+0x1484>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    380a:	e3a50513          	addi	a0,a0,-454 # 7640 <malloc+0x1644>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    381e:	e5650513          	addi	a0,a0,-426 # 7670 <malloc+0x1674>
  ...
  if(chdir("./..") != 0){
    ...
    3832:	e7250513          	addi	a0,a0,-398 # 76a0 <malloc+0x16a4>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3848:	d6450513          	addi	a0,a0,-668 # 75a8 <malloc+0x15ac>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3882:	ca250513          	addi	a0,a0,-862 # 7520 <malloc+0x1524>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    389a:	e9a50513          	addi	a0,a0,-358 # 7730 <malloc+0x1734>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b2:	eb250513          	addi	a0,a0,-334 # 7760 <malloc+0x1764>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38ca:	bba50513          	addi	a0,a0,-1094 # 7480 <malloc+0x1484>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38e0:	ba450513          	addi	a0,a0,-1116 # 7480 <malloc+0x1484>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f6:	b8e50513          	addi	a0,a0,-1138 # 7480 <malloc+0x1484>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    390a:	eea58593          	addi	a1,a1,-278 # 77f0 <malloc+0x17f4>
    390e:	00004517          	auipc	a0,0x4
    3912:	e2250513          	addi	a0,a0,-478 # 7730 <malloc+0x1734>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3926:	ece58593          	addi	a1,a1,-306 # 77f0 <malloc+0x17f4>
    392a:	00004517          	auipc	a0,0x4
    392e:	e3650513          	addi	a0,a0,-458 # 7760 <malloc+0x1764>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3942:	c6a58593          	addi	a1,a1,-918 # 75a8 <malloc+0x15ac>
    3946:	00004517          	auipc	a0,0x4
    394a:	b5a50513          	addi	a0,a0,-1190 # 74a0 <malloc+0x14a4>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    395e:	dd650513          	addi	a0,a0,-554 # 7730 <malloc+0x1734>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3972:	df250513          	addi	a0,a0,-526 # 7760 <malloc+0x1764>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3986:	c2650513          	addi	a0,a0,-986 # 75a8 <malloc+0x15ac>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    399a:	dca50513          	addi	a0,a0,-566 # 7760 <malloc+0x1764>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39ae:	d8650513          	addi	a0,a0,-634 # 7730 <malloc+0x1734>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c2:	ae250513          	addi	a0,a0,-1310 # 74a0 <malloc+0x14a4>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d6:	f6e50513          	addi	a0,a0,-146 # 7940 <malloc+0x1944>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39ea:	bc250513          	addi	a0,a0,-1086 # 75a8 <malloc+0x15ac>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39fe:	aa650513          	addi	a0,a0,-1370 # 74a0 <malloc+0x14a4>
  ...
  if(unlink("dd") == 0){
    ...
    3a12:	a7250513          	addi	a0,a0,-1422 # 7480 <malloc+0x1484>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a26:	f8e50513          	addi	a0,a0,-114 # 79b0 <malloc+0x19b4>
  ...
  if(unlink("dd") < 0){
    ...
    3a3a:	a4a50513          	addi	a0,a0,-1462 # 7480 <malloc+0x1484>
    ...
    3a5c:	a3050513          	addi	a0,a0,-1488 # 7488 <malloc+0x148c>
    3a60:	00002097          	auipc	ra,0x2
    3a64:	4de080e7          	jalr	1246(ra) # 5f3e <printf>
    exit(1);
    3a68:	4505                	li	a0,1
    ...
    3a78:	a3450513          	addi	a0,a0,-1484 # 74a8 <malloc+0x14ac>
    3a7c:	00002097          	auipc	ra,0x2
    3a80:	4c2080e7          	jalr	1218(ra) # 5f3e <printf>
    exit(1);
    3a84:	4505                	li	a0,1
    ...
    3a94:	a3850513          	addi	a0,a0,-1480 # 74c8 <malloc+0x14cc>
    3a98:	00002097          	auipc	ra,0x2
    3a9c:	4a6080e7          	jalr	1190(ra) # 5f3e <printf>
    exit(1);
    3aa0:	4505                	li	a0,1
    ...
    3ab0:	a5450513          	addi	a0,a0,-1452 # 7500 <malloc+0x1504>
    3ab4:	00002097          	auipc	ra,0x2
    3ab8:	48a080e7          	jalr	1162(ra) # 5f3e <printf>
    exit(1);
    3abc:	4505                	li	a0,1
    ...
    3acc:	a6850513          	addi	a0,a0,-1432 # 7530 <malloc+0x1534>
    3ad0:	00002097          	auipc	ra,0x2
    3ad4:	46e080e7          	jalr	1134(ra) # 5f3e <printf>
    exit(1);
    3ad8:	4505                	li	a0,1
    ...
    3ae8:	a8450513          	addi	a0,a0,-1404 # 7568 <malloc+0x156c>
    3aec:	00002097          	auipc	ra,0x2
    3af0:	452080e7          	jalr	1106(ra) # 5f3e <printf>
    exit(1);
    3af4:	4505                	li	a0,1
    ...
    3b04:	a8850513          	addi	a0,a0,-1400 # 7588 <malloc+0x158c>
    3b08:	00002097          	auipc	ra,0x2
    3b0c:	436080e7          	jalr	1078(ra) # 5f3e <printf>
    exit(1);
    3b10:	4505                	li	a0,1
    ...
    3b20:	a9c50513          	addi	a0,a0,-1380 # 75b8 <malloc+0x15bc>
    3b24:	00002097          	auipc	ra,0x2
    3b28:	41a080e7          	jalr	1050(ra) # 5f3e <printf>
    exit(1);
    3b2c:	4505                	li	a0,1
    ...
    3b3c:	aa850513          	addi	a0,a0,-1368 # 75e0 <malloc+0x15e4>
    3b40:	00002097          	auipc	ra,0x2
    3b44:	3fe080e7          	jalr	1022(ra) # 5f3e <printf>
    exit(1);
    3b48:	4505                	li	a0,1
    ...
    3b58:	aac50513          	addi	a0,a0,-1364 # 7600 <malloc+0x1604>
    3b5c:	00002097          	auipc	ra,0x2
    3b60:	3e2080e7          	jalr	994(ra) # 5f3e <printf>
    exit(1);
    3b64:	4505                	li	a0,1
    ...
    3b74:	ab850513          	addi	a0,a0,-1352 # 7628 <malloc+0x162c>
    3b78:	00002097          	auipc	ra,0x2
    3b7c:	3c6080e7          	jalr	966(ra) # 5f3e <printf>
    exit(1);
    3b80:	4505                	li	a0,1
    ...
    3b90:	ac450513          	addi	a0,a0,-1340 # 7650 <malloc+0x1654>
    3b94:	00002097          	auipc	ra,0x2
    3b98:	3aa080e7          	jalr	938(ra) # 5f3e <printf>
    exit(1);
    3b9c:	4505                	li	a0,1
    ...
    3bac:	ad850513          	addi	a0,a0,-1320 # 7680 <malloc+0x1684>
    3bb0:	00002097          	auipc	ra,0x2
    3bb4:	38e080e7          	jalr	910(ra) # 5f3e <printf>
    exit(1);
    3bb8:	4505                	li	a0,1
    ...
    3bc8:	ae450513          	addi	a0,a0,-1308 # 76a8 <malloc+0x16ac>
    3bcc:	00002097          	auipc	ra,0x2
    3bd0:	372080e7          	jalr	882(ra) # 5f3e <printf>
    exit(1);
    3bd4:	4505                	li	a0,1
    ...
    3be4:	ae050513          	addi	a0,a0,-1312 # 76c0 <malloc+0x16c4>
    3be8:	00002097          	auipc	ra,0x2
    3bec:	356080e7          	jalr	854(ra) # 5f3e <printf>
    exit(1);
    3bf0:	4505                	li	a0,1
    ...
    3c00:	ae450513          	addi	a0,a0,-1308 # 76e0 <malloc+0x16e4>
    3c04:	00002097          	auipc	ra,0x2
    3c08:	33a080e7          	jalr	826(ra) # 5f3e <printf>
    exit(1);
    3c0c:	4505                	li	a0,1
    ...
    3c1c:	ae850513          	addi	a0,a0,-1304 # 7700 <malloc+0x1704>
    3c20:	00002097          	auipc	ra,0x2
    3c24:	31e080e7          	jalr	798(ra) # 5f3e <printf>
    exit(1);
    3c28:	4505                	li	a0,1
    ...
    3c38:	b0c50513          	addi	a0,a0,-1268 # 7740 <malloc+0x1744>
    3c3c:	00002097          	auipc	ra,0x2
    3c40:	302080e7          	jalr	770(ra) # 5f3e <printf>
    exit(1);
    3c44:	4505                	li	a0,1
    ...
    3c54:	b2050513          	addi	a0,a0,-1248 # 7770 <malloc+0x1774>
    3c58:	00002097          	auipc	ra,0x2
    3c5c:	2e6080e7          	jalr	742(ra) # 5f3e <printf>
    exit(1);
    3c60:	4505                	li	a0,1
    ...
    3c70:	b2450513          	addi	a0,a0,-1244 # 7790 <malloc+0x1794>
    3c74:	00002097          	auipc	ra,0x2
    3c78:	2ca080e7          	jalr	714(ra) # 5f3e <printf>
    exit(1);
    3c7c:	4505                	li	a0,1
    ...
    3c8c:	b2850513          	addi	a0,a0,-1240 # 77b0 <malloc+0x17b4>
    3c90:	00002097          	auipc	ra,0x2
    3c94:	2ae080e7          	jalr	686(ra) # 5f3e <printf>
    exit(1);
    3c98:	4505                	li	a0,1
    ...
    3ca8:	b2c50513          	addi	a0,a0,-1236 # 77d0 <malloc+0x17d4>
    3cac:	00002097          	auipc	ra,0x2
    3cb0:	292080e7          	jalr	658(ra) # 5f3e <printf>
    exit(1);
    3cb4:	4505                	li	a0,1
    ...
    3cc4:	b4050513          	addi	a0,a0,-1216 # 7800 <malloc+0x1804>
    3cc8:	00002097          	auipc	ra,0x2
    3ccc:	276080e7          	jalr	630(ra) # 5f3e <printf>
    exit(1);
    3cd0:	4505                	li	a0,1
    ...
    3ce0:	b4c50513          	addi	a0,a0,-1204 # 7828 <malloc+0x182c>
    3ce4:	00002097          	auipc	ra,0x2
    3ce8:	25a080e7          	jalr	602(ra) # 5f3e <printf>
    exit(1);
    3cec:	4505                	li	a0,1
    ...
    3cfc:	b5850513          	addi	a0,a0,-1192 # 7850 <malloc+0x1854>
    3d00:	00002097          	auipc	ra,0x2
    3d04:	23e080e7          	jalr	574(ra) # 5f3e <printf>
    exit(1);
    3d08:	4505                	li	a0,1
    ...
    3d18:	b6450513          	addi	a0,a0,-1180 # 7878 <malloc+0x187c>
    3d1c:	00002097          	auipc	ra,0x2
    3d20:	222080e7          	jalr	546(ra) # 5f3e <printf>
    exit(1);
    3d24:	4505                	li	a0,1
    ...
    3d34:	b6850513          	addi	a0,a0,-1176 # 7898 <malloc+0x189c>
    3d38:	00002097          	auipc	ra,0x2
    3d3c:	206080e7          	jalr	518(ra) # 5f3e <printf>
    exit(1);
    3d40:	4505                	li	a0,1
    ...
    3d50:	b6c50513          	addi	a0,a0,-1172 # 78b8 <malloc+0x18bc>
    3d54:	00002097          	auipc	ra,0x2
    3d58:	1ea080e7          	jalr	490(ra) # 5f3e <printf>
    exit(1);
    3d5c:	4505                	li	a0,1
    ...
    3d6c:	b7850513          	addi	a0,a0,-1160 # 78e0 <malloc+0x18e4>
    3d70:	00002097          	auipc	ra,0x2
    3d74:	1ce080e7          	jalr	462(ra) # 5f3e <printf>
    exit(1);
    3d78:	4505                	li	a0,1
    ...
    3d88:	b7c50513          	addi	a0,a0,-1156 # 7900 <malloc+0x1904>
    3d8c:	00002097          	auipc	ra,0x2
    3d90:	1b2080e7          	jalr	434(ra) # 5f3e <printf>
    exit(1);
    3d94:	4505                	li	a0,1
    ...
    3da4:	b8050513          	addi	a0,a0,-1152 # 7920 <malloc+0x1924>
    3da8:	00002097          	auipc	ra,0x2
    3dac:	196080e7          	jalr	406(ra) # 5f3e <printf>
    exit(1);
    3db0:	4505                	li	a0,1
    ...
    3dc0:	b8c50513          	addi	a0,a0,-1140 # 7948 <malloc+0x194c>
    3dc4:	00002097          	auipc	ra,0x2
    3dc8:	17a080e7          	jalr	378(ra) # 5f3e <printf>
    exit(1);
    3dcc:	4505                	li	a0,1
    ...
    3ddc:	80850513          	addi	a0,a0,-2040 # 75e0 <malloc+0x15e4>
    3de0:	00002097          	auipc	ra,0x2
    3de4:	15e080e7          	jalr	350(ra) # 5f3e <printf>
    exit(1);
    3de8:	4505                	li	a0,1
    ...
    3df8:	b7450513          	addi	a0,a0,-1164 # 7968 <malloc+0x196c>
    3dfc:	00002097          	auipc	ra,0x2
    3e00:	142080e7          	jalr	322(ra) # 5f3e <printf>
    exit(1);
    3e04:	4505                	li	a0,1
    ...
    3e14:	b7850513          	addi	a0,a0,-1160 # 7988 <malloc+0x198c>
    3e18:	00002097          	auipc	ra,0x2
    3e1c:	126080e7          	jalr	294(ra) # 5f3e <printf>
    exit(1);
    3e20:	4505                	li	a0,1
    ...
    3e30:	b8c50513          	addi	a0,a0,-1140 # 79b8 <malloc+0x19bc>
    3e34:	00002097          	auipc	ra,0x2
    3e38:	10a080e7          	jalr	266(ra) # 5f3e <printf>
    exit(1);
    3e3c:	4505                	li	a0,1
    ...
    3e4c:	b9050513          	addi	a0,a0,-1136 # 79d8 <malloc+0x19dc>
    3e50:	00002097          	auipc	ra,0x2
    3e54:	0ee080e7          	jalr	238(ra) # 5f3e <printf>
    exit(1);
    3e58:	4505                	li	a0,1
...
0000000000003e62 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e72:	b8250513          	addi	a0,a0,-1150 # 79f0 <malloc+0x19f4>
  ...
  if(chdir("dots") != 0){
    ...
    3e84:	b7050513          	addi	a0,a0,-1168 # 79f0 <malloc+0x19f4>
  ...
  if(unlink(".") == 0){
    ...
    3e96:	98e50513          	addi	a0,a0,-1650 # 6820 <malloc+0x824>
  ...
  if(unlink("..") == 0){
    ...
    3ea8:	5a450513          	addi	a0,a0,1444 # 7448 <malloc+0x144c>
  ...
  if(chdir("/") != 0){
    ...
    3eba:	53a50513          	addi	a0,a0,1338 # 73f0 <malloc+0x13f4>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ecc:	b9050513          	addi	a0,a0,-1136 # 7a58 <malloc+0x1a5c>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ede:	ba650513          	addi	a0,a0,-1114 # 7a80 <malloc+0x1a84>
  ...
  if(unlink("dots") != 0){
    ...
    3ef0:	b0450513          	addi	a0,a0,-1276 # 79f0 <malloc+0x19f4>
    ...
    3f0e:	aee50513          	addi	a0,a0,-1298 # 79f8 <malloc+0x19fc>
    3f12:	00002097          	auipc	ra,0x2
    3f16:	02c080e7          	jalr	44(ra) # 5f3e <printf>
    exit(1);
    3f1a:	4505                	li	a0,1
    ...
    3f2a:	aea50513          	addi	a0,a0,-1302 # 7a10 <malloc+0x1a14>
    3f2e:	00002097          	auipc	ra,0x2
    3f32:	010080e7          	jalr	16(ra) # 5f3e <printf>
    exit(1);
    3f36:	4505                	li	a0,1
    ...
    3f46:	ae650513          	addi	a0,a0,-1306 # 7a28 <malloc+0x1a2c>
    3f4a:	00002097          	auipc	ra,0x2
    3f4e:	ff4080e7          	jalr	-12(ra) # 5f3e <printf>
    exit(1);
    3f52:	4505                	li	a0,1
    ...
    3f62:	ae250513          	addi	a0,a0,-1310 # 7a40 <malloc+0x1a44>
    3f66:	00002097          	auipc	ra,0x2
    3f6a:	fd8080e7          	jalr	-40(ra) # 5f3e <printf>
    exit(1);
    3f6e:	4505                	li	a0,1
    ...
    3f7e:	47e50513          	addi	a0,a0,1150 # 73f8 <malloc+0x13fc>
    3f82:	00002097          	auipc	ra,0x2
    3f86:	fbc080e7          	jalr	-68(ra) # 5f3e <printf>
    exit(1);
    3f8a:	4505                	li	a0,1
    ...
    3f9a:	aca50513          	addi	a0,a0,-1334 # 7a60 <malloc+0x1a64>
    3f9e:	00002097          	auipc	ra,0x2
    3fa2:	fa0080e7          	jalr	-96(ra) # 5f3e <printf>
    exit(1);
    3fa6:	4505                	li	a0,1
    ...
    3fb6:	ad650513          	addi	a0,a0,-1322 # 7a88 <malloc+0x1a8c>
    3fba:	00002097          	auipc	ra,0x2
    3fbe:	f84080e7          	jalr	-124(ra) # 5f3e <printf>
    exit(1);
    3fc2:	4505                	li	a0,1
    ...
    3fd2:	ada50513          	addi	a0,a0,-1318 # 7aa8 <malloc+0x1aac>
    3fd6:	00002097          	auipc	ra,0x2
    3fda:	f68080e7          	jalr	-152(ra) # 5f3e <printf>
    exit(1);
    3fde:	4505                	li	a0,1
...
0000000000003fe8 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ffe:	ace50513          	addi	a0,a0,-1330 # 7ac8 <malloc+0x1acc>
  ...
  if(chdir("dirfile") == 0){
    ...
    401a:	ab250513          	addi	a0,a0,-1358 # 7ac8 <malloc+0x1acc>
  ...
  fd = open("dirfile/xx", 0);
    ...
    402e:	ae650513          	addi	a0,a0,-1306 # 7b10 <malloc+0x1b14>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4046:	ace50513          	addi	a0,a0,-1330 # 7b10 <malloc+0x1b14>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    405a:	aba50513          	addi	a0,a0,-1350 # 7b10 <malloc+0x1b14>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    406e:	aa650513          	addi	a0,a0,-1370 # 7b10 <malloc+0x1b14>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4082:	a9258593          	addi	a1,a1,-1390 # 7b10 <malloc+0x1b14>
    4086:	00002517          	auipc	a0,0x2
    408a:	28a50513          	addi	a0,a0,650 # 6310 <malloc+0x314>
  ...
  if(unlink("dirfile") != 0){
    ...
    409e:	a2e50513          	addi	a0,a0,-1490 # 7ac8 <malloc+0x1acc>
  ...
  fd = open(".", O_RDWR);
    ...
    40b4:	77050513          	addi	a0,a0,1904 # 6820 <malloc+0x824>
  ...
  fd = open(".", 0);
    ...
    40ca:	75a50513          	addi	a0,a0,1882 # 6820 <malloc+0x824>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40de:	0ce58593          	addi	a1,a1,206 # 61a8 <malloc+0x1ac>
  ...
  close(fd);
    ...
    410a:	9ca50513          	addi	a0,a0,-1590 # 7ad0 <malloc+0x1ad4>
    410e:	00002097          	auipc	ra,0x2
    4112:	e30080e7          	jalr	-464(ra) # 5f3e <printf>
    exit(1);
    4116:	4505                	li	a0,1
    ...
    4126:	9ce50513          	addi	a0,a0,-1586 # 7af0 <malloc+0x1af4>
    412a:	00002097          	auipc	ra,0x2
    412e:	e14080e7          	jalr	-492(ra) # 5f3e <printf>
    exit(1);
    4132:	4505                	li	a0,1
    ...
    4142:	9e250513          	addi	a0,a0,-1566 # 7b20 <malloc+0x1b24>
    4146:	00002097          	auipc	ra,0x2
    414a:	df8080e7          	jalr	-520(ra) # 5f3e <printf>
    exit(1);
    414e:	4505                	li	a0,1
    ...
    415e:	9c650513          	addi	a0,a0,-1594 # 7b20 <malloc+0x1b24>
    4162:	00002097          	auipc	ra,0x2
    4166:	ddc080e7          	jalr	-548(ra) # 5f3e <printf>
    exit(1);
    416a:	4505                	li	a0,1
    ...
    417a:	9d250513          	addi	a0,a0,-1582 # 7b48 <malloc+0x1b4c>
    417e:	00002097          	auipc	ra,0x2
    4182:	dc0080e7          	jalr	-576(ra) # 5f3e <printf>
    exit(1);
    4186:	4505                	li	a0,1
    ...
    4196:	9de50513          	addi	a0,a0,-1570 # 7b70 <malloc+0x1b74>
    419a:	00002097          	auipc	ra,0x2
    419e:	da4080e7          	jalr	-604(ra) # 5f3e <printf>
    exit(1);
    41a2:	4505                	li	a0,1
    ...
    41b2:	9ea50513          	addi	a0,a0,-1558 # 7b98 <malloc+0x1b9c>
    41b6:	00002097          	auipc	ra,0x2
    41ba:	d88080e7          	jalr	-632(ra) # 5f3e <printf>
    exit(1);
    41be:	4505                	li	a0,1
    ...
    41ce:	9f650513          	addi	a0,a0,-1546 # 7bc0 <malloc+0x1bc4>
    41d2:	00002097          	auipc	ra,0x2
    41d6:	d6c080e7          	jalr	-660(ra) # 5f3e <printf>
    exit(1);
    41da:	4505                	li	a0,1
    ...
    41ea:	9fa50513          	addi	a0,a0,-1542 # 7be0 <malloc+0x1be4>
    41ee:	00002097          	auipc	ra,0x2
    41f2:	d50080e7          	jalr	-688(ra) # 5f3e <printf>
    exit(1);
    41f6:	4505                	li	a0,1
    ...
    4206:	a0650513          	addi	a0,a0,-1530 # 7c08 <malloc+0x1c0c>
    420a:	00002097          	auipc	ra,0x2
    420e:	d34080e7          	jalr	-716(ra) # 5f3e <printf>
    exit(1);
    4212:	4505                	li	a0,1
...
000000000000421c <iref>:
{
    ...
    423a:	9eaa0a13          	addi	s4,s4,-1558 # 7c20 <malloc+0x1c24>
    mkdir("");
    423e:	00003497          	auipc	s1,0x3
    4242:	4ea48493          	addi	s1,s1,1258 # 7728 <malloc+0x172c>
    link("README", "");
    4246:	00002a97          	auipc	s5,0x2
    424a:	0caa8a93          	addi	s5,s5,202 # 6310 <malloc+0x314>
    fd = open("xx", O_CREATE);
    424e:	00004997          	auipc	s3,0x4
    4252:	8ca98993          	addi	s3,s3,-1846 # 7b18 <malloc+0x1b1c>
    4256:	a891                	j	42aa <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4258:	85da                	mv	a1,s6
    425a:	00004517          	auipc	a0,0x4
    425e:	9ce50513          	addi	a0,a0,-1586 # 7c28 <malloc+0x1c2c>
    4262:	00002097          	auipc	ra,0x2
    4266:	cdc080e7          	jalr	-804(ra) # 5f3e <printf>
      exit(1);
    426a:	4505                	li	a0,1
    ...
    427a:	9ca50513          	addi	a0,a0,-1590 # 7c40 <malloc+0x1c44>
    427e:	00002097          	auipc	ra,0x2
    4282:	cc0080e7          	jalr	-832(ra) # 5f3e <printf>
      exit(1);
    4286:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    430e:	13e98993          	addi	s3,s3,318 # 7448 <malloc+0x144c>
    unlink("irefd");
    4312:	00004917          	auipc	s2,0x4
    4316:	90e90913          	addi	s2,s2,-1778 # 7c20 <malloc+0x1c24>
    chdir("..");
    431a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4336:	0be50513          	addi	a0,a0,190 # 73f0 <malloc+0x13f4>
...
0000000000004356 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4366:	8f650513          	addi	a0,a0,-1802 # 7c58 <malloc+0x1c5c>
  ...
  if(pid == 0){
    ...
    438a:	8d250513          	addi	a0,a0,-1838 # 7c58 <malloc+0x1c5c>
    ...
    43a0:	8dc50513          	addi	a0,a0,-1828 # 7c78 <malloc+0x1c7c>
    43a4:	00002097          	auipc	ra,0x2
    43a8:	b9a080e7          	jalr	-1126(ra) # 5f3e <printf>
      exit(1);
    43ac:	4505                	li	a0,1
    ...
    43bc:	8a850513          	addi	a0,a0,-1880 # 7c60 <malloc+0x1c64>
    43c0:	00002097          	auipc	ra,0x2
    43c4:	b7e080e7          	jalr	-1154(ra) # 5f3e <printf>
    exit(1);
    43c8:	4505                	li	a0,1
    ...
    43d8:	5ec50513          	addi	a0,a0,1516 # 69c0 <malloc+0x9c4>
    43dc:	00002097          	auipc	ra,0x2
    43e0:	b62080e7          	jalr	-1182(ra) # 5f3e <printf>
    exit(1);
    43e4:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4406:	85650513          	addi	a0,a0,-1962 # 7c58 <malloc+0x1c5c>
    ...
    441a:	79a50513          	addi	a0,a0,1946 # 6bb0 <malloc+0xbb4>
    441e:	00002097          	auipc	ra,0x2
    4422:	b20080e7          	jalr	-1248(ra) # 5f3e <printf>
    exit(1);
    4426:	4505                	li	a0,1
...
0000000000004448 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4458:	84c50513          	addi	a0,a0,-1972 # 7ca0 <malloc+0x1ca4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4484:	82050513          	addi	a0,a0,-2016 # 7ca0 <malloc+0x1ca4>
  ...
  sleep(10); // one second
    ...
    44bc:	6c850513          	addi	a0,a0,1736 # 6b80 <malloc+0xb84>
    44c0:	00002097          	auipc	ra,0x2
    44c4:	a7e080e7          	jalr	-1410(ra) # 5f3e <printf>
    exit(1);
    44c8:	4505                	li	a0,1
    ...
    44d6:	7ce48493          	addi	s1,s1,1998 # 7ca0 <malloc+0x1ca4>
    44da:	4581                	li	a1,0
    44dc:	8526                	mv	a0,s1
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	44650513          	addi	a0,a0,1094 # 69c0 <malloc+0x9c4>
    ...
    45a4:	71050513          	addi	a0,a0,1808 # 7cb0 <malloc+0x1cb4>
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	5a050513          	addi	a0,a0,1440 # 6b80 <malloc+0xb84>
  ...
  if(pid2 == 0)
    ...
    4612:	3b250513          	addi	a0,a0,946 # 69c0 <malloc+0x9c4>
  ...
  if(pid3 == 0){
    ...
    4656:	b5658593          	addi	a1,a1,-1194 # 61a8 <malloc+0x1ac>
    ...
    4680:	34450513          	addi	a0,a0,836 # 69c0 <malloc+0x9c4>
    ...
    469c:	63850513          	addi	a0,a0,1592 # 7cd0 <malloc+0x1cd4>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	61450513          	addi	a0,a0,1556 # 7ce8 <malloc+0x1cec>
  ...
  printf("kill... ");
    ...
    4704:	60050513          	addi	a0,a0,1536 # 7d00 <malloc+0x1d04>
  ...
  printf("wait... ");
    ...
    4732:	5e250513          	addi	a0,a0,1506 # 7d10 <malloc+0x1d14>
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	21250513          	addi	a0,a0,530 # 69c0 <malloc+0x9c4>
    ...
    47ce:	37e50513          	addi	a0,a0,894 # 6b48 <malloc+0xb4c>
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	28850513          	addi	a0,a0,648 # 6ac8 <malloc+0xacc>
    ...
    4878:	93458593          	addi	a1,a1,-1740 # 61a8 <malloc+0x1ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	3e850513          	addi	a0,a0,1000 # 7d20 <malloc+0x1d24>
    ...
    4958:	06c50513          	addi	a0,a0,108 # 69c0 <malloc+0x9c4>
    ...
    49a4:	3a050513          	addi	a0,a0,928 # 7d40 <malloc+0x1d44>
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a0e:	5f2080e7          	jalr	1522(ra) # 5ffc <malloc>
    ...
    4a2a:	5d6080e7          	jalr	1494(ra) # 5ffc <malloc>
    if(m1 == 0){
    ...
    4a48:	32c50513          	addi	a0,a0,812 # 7d70 <malloc+0x1d74>
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	2a650513          	addi	a0,a0,678 # 7da0 <malloc+0x1da4>
    ...
    4b1a:	2b250513          	addi	a0,a0,690 # 7dc8 <malloc+0x1dcc>
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	23650513          	addi	a0,a0,566 # 7d90 <malloc+0x1d94>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	24e50513          	addi	a0,a0,590 # 7de8 <malloc+0x1dec>
  ...
  unlink("sharedfd");
    ...
    4bda:	1ba50513          	addi	a0,a0,442 # 7d90 <malloc+0x1d94>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	21450513          	addi	a0,a0,532 # 7e10 <malloc+0x1e14>
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c46:	49e78793          	addi	a5,a5,1182 # 60e0 <malloc+0xe4>
    4c4a:	f6f43823          	sd	a5,-144(s0)
    4c4e:	00001797          	auipc	a5,0x1
    4c52:	49a78793          	addi	a5,a5,1178 # 60e8 <malloc+0xec>
    4c56:	f6f43c23          	sd	a5,-136(s0)
    4c5a:	00001797          	auipc	a5,0x1
    4c5e:	49678793          	addi	a5,a5,1174 # 60f0 <malloc+0xf4>
    4c62:	f8f43023          	sd	a5,-128(s0)
    4c66:	00001797          	auipc	a5,0x1
    4c6a:	49278793          	addi	a5,a5,1170 # 60f8 <malloc+0xfc>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce2:	0ea50513          	addi	a0,a0,234 # 6dc8 <malloc+0xdcc>
    4ce6:	00001097          	auipc	ra,0x1
    4cea:	258080e7          	jalr	600(ra) # 5f3e <printf>
      exit(1);
    4cee:	4505                	li	a0,1
    ...
    4d5e:	0ce50513          	addi	a0,a0,206 # 7e28 <malloc+0x1e2c>
    4d62:	00001097          	auipc	ra,0x1
    4d66:	1dc080e7          	jalr	476(ra) # 5f3e <printf>
        exit(1);
    4d6a:	4505                	li	a0,1
    ...
    4d78:	0c450513          	addi	a0,a0,196 # 7e38 <malloc+0x1e3c>
    4d7c:	00001097          	auipc	ra,0x1
    4d80:	1c2080e7          	jalr	450(ra) # 5f3e <printf>
          exit(1);
    4d84:	4505                	li	a0,1
    ...
    4da0:	0b450513          	addi	a0,a0,180 # 7e50 <malloc+0x1e54>
    4da4:	00001097          	auipc	ra,0x1
    4da8:	19a080e7          	jalr	410(ra) # 5f3e <printf>
          exit(1);
    4dac:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e2e:	03650513          	addi	a0,a0,54 # 7e60 <malloc+0x1e64>
    4e32:	00001097          	auipc	ra,0x1
    4e36:	10c080e7          	jalr	268(ra) # 5f3e <printf>
      exit(1);
    4e3a:	4505                	li	a0,1
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e90:	fecb8b93          	addi	s7,s7,-20 # 7e78 <malloc+0x1e7c>
  for(i = 0; i < N; i++){
    ...
    4ed2:	fb250513          	addi	a0,a0,-78 # 7e80 <malloc+0x1e84>
    4ed6:	00001097          	auipc	ra,0x1
    4eda:	068080e7          	jalr	104(ra) # 5f3e <printf>
        exit(1);
    4ede:	4505                	li	a0,1
    ...
    4ef0:	f8c50513          	addi	a0,a0,-116 # 7e78 <malloc+0x1e7c>
  ...
  fd = open(".", 0);
    ...
    4f28:	8fc50513          	addi	a0,a0,-1796 # 6820 <malloc+0x824>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9e:	f0650513          	addi	a0,a0,-250 # 7ea0 <malloc+0x1ea4>
    4fa2:	00001097          	auipc	ra,0x1
    4fa6:	f9c080e7          	jalr	-100(ra) # 5f3e <printf>
        exit(1);
    4faa:	4505                	li	a0,1
    ...
    4fbe:	f0650513          	addi	a0,a0,-250 # 7ec0 <malloc+0x1ec4>
    4fc2:	00001097          	auipc	ra,0x1
    4fc6:	f7c080e7          	jalr	-132(ra) # 5f3e <printf>
        exit(1);
    4fca:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4ff6:	ef650513          	addi	a0,a0,-266 # 7ee8 <malloc+0x1eec>
    4ffa:	00001097          	auipc	ra,0x1
    4ffe:	f44080e7          	jalr	-188(ra) # 5f3e <printf>
    exit(1);
    5002:	4505                	li	a0,1
    ...
    5012:	9b250513          	addi	a0,a0,-1614 # 69c0 <malloc+0x9c4>
    5016:	00001097          	auipc	ra,0x1
    501a:	f28080e7          	jalr	-216(ra) # 5f3e <printf>
      exit(1);
    501e:	4505                	li	a0,1
...
00000000000051bc <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5244:	ce050513          	addi	a0,a0,-800 # 7f20 <malloc+0x1f24>
  ...
  for(i = 0; ; i++){
    ...
    52a8:	c8c50513          	addi	a0,a0,-884 # 7f30 <malloc+0x1f34>
    52ac:	00001097          	auipc	ra,0x1
    52b0:	c92080e7          	jalr	-878(ra) # 5f3e <printf>
    exit(1);
    52b4:	4505                	li	a0,1
    ...
    52c4:	c9050513          	addi	a0,a0,-880 # 7f50 <malloc+0x1f54>
    52c8:	00001097          	auipc	ra,0x1
    52cc:	c76080e7          	jalr	-906(ra) # 5f3e <printf>
      exit(1);
    52d0:	4505                	li	a0,1
    ...
    52e0:	c9450513          	addi	a0,a0,-876 # 7f70 <malloc+0x1f74>
    52e4:	00001097          	auipc	ra,0x1
    52e8:	c5a080e7          	jalr	-934(ra) # 5f3e <printf>
    exit(1);
    52ec:	4505                	li	a0,1
    ...
    52fc:	c9850513          	addi	a0,a0,-872 # 7f90 <malloc+0x1f94>
    5300:	00001097          	auipc	ra,0x1
    5304:	c3e080e7          	jalr	-962(ra) # 5f3e <printf>
      exit(1);
    5308:	4505                	li	a0,1
    ...
    5318:	c9c50513          	addi	a0,a0,-868 # 7fb0 <malloc+0x1fb4>
    531c:	00001097          	auipc	ra,0x1
    5320:	c22080e7          	jalr	-990(ra) # 5f3e <printf>
      exit(1);
    5324:	4505                	li	a0,1
    ...
    5334:	c9850513          	addi	a0,a0,-872 # 7fc8 <malloc+0x1fcc>
    5338:	00001097          	auipc	ra,0x1
    533c:	c06080e7          	jalr	-1018(ra) # 5f3e <printf>
      exit(1);
    5340:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    5362:	bc250513          	addi	a0,a0,-1086 # 7f20 <malloc+0x1f24>
    ...
    5386:	c6650513          	addi	a0,a0,-922 # 7fe8 <malloc+0x1fec>
    538a:	00001097          	auipc	ra,0x1
    538e:	bb4080e7          	jalr	-1100(ra) # 5f3e <printf>
    exit(1);
    5392:	4505                	li	a0,1
...
000000000000539c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53be:	c4e50513          	addi	a0,a0,-946 # 8008 <malloc+0x200c>
    53c2:	00001097          	auipc	ra,0x1
    53c6:	b7c080e7          	jalr	-1156(ra) # 5f3e <printf>
  for(nfiles = 0; ; nfiles++){
    53ca:	4481                	li	s1,0
    name[0] = 'f';
    ...
    53de:	c3ec8c93          	addi	s9,s9,-962 # 8018 <malloc+0x201c>
    int total = 0;
    53e2:	4d81                	li	s11,0
    ...
    5436:	b0c080e7          	jalr	-1268(ra) # 5f3e <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5458:	bd450513          	addi	a0,a0,-1068 # 8028 <malloc+0x202c>
    545c:	00001097          	auipc	ra,0x1
    5460:	ae2080e7          	jalr	-1310(ra) # 5f3e <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    54ce:	b7e50513          	addi	a0,a0,-1154 # 8048 <malloc+0x204c>
    54d2:	00001097          	auipc	ra,0x1
    54d6:	a6c080e7          	jalr	-1428(ra) # 5f3e <printf>
}
    ...
    551e:	b1e50513          	addi	a0,a0,-1250 # 8038 <malloc+0x203c>
    5522:	00001097          	auipc	ra,0x1
    5526:	a1c080e7          	jalr	-1508(ra) # 5f3e <printf>
    close(fd);
    552a:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5550:	b1450513          	addi	a0,a0,-1260 # 8060 <malloc+0x2064>
    5554:	00001097          	auipc	ra,0x1
    5558:	9ea080e7          	jalr	-1558(ra) # 5f3e <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5580:	b0c50513          	addi	a0,a0,-1268 # 8088 <malloc+0x208c>
    5584:	00001097          	auipc	ra,0x1
    5588:	9ba080e7          	jalr	-1606(ra) # 5f3e <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55a4:	ad050513          	addi	a0,a0,-1328 # 8070 <malloc+0x2074>
    55a8:	00001097          	auipc	ra,0x1
    55ac:	996080e7          	jalr	-1642(ra) # 5f3e <printf>
    exit(1);
    55b0:	4505                	li	a0,1
    ...
    55cc:	ac850513          	addi	a0,a0,-1336 # 8090 <malloc+0x2094>
    55d0:	00001097          	auipc	ra,0x1
    55d4:	96e080e7          	jalr	-1682(ra) # 5f3e <printf>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    561c:	a8050513          	addi	a0,a0,-1408 # 8098 <malloc+0x209c>
    5620:	00001097          	auipc	ra,0x1
    5624:	91e080e7          	jalr	-1762(ra) # 5f3e <printf>
        return 1;
    5628:	4505                	li	a0,1
}
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5676:	b3698993          	addi	s3,s3,-1226 # 61a8 <malloc+0x1ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a8:	a4c50513          	addi	a0,a0,-1460 # 80f0 <malloc+0x20f4>
    ...
    56c2:	9f250513          	addi	a0,a0,-1550 # 80b0 <malloc+0x20b4>
    ...
    56dc:	9f850513          	addi	a0,a0,-1544 # 80d0 <malloc+0x20d4>
    56e0:	00001097          	auipc	ra,0x1
    56e4:	85e080e7          	jalr	-1954(ra) # 5f3e <printf>
    exit(1);
    56e8:	4505                	li	a0,1
  ...
  while(1){
    ...
    572a:	9ea50513          	addi	a0,a0,-1558 # 8110 <malloc+0x2114>
    572e:	00001097          	auipc	ra,0x1
    5732:	810080e7          	jalr	-2032(ra) # 5f3e <printf>
      exit(1);
    5736:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    578c:	9a8b8b93          	addi	s7,s7,-1624 # 8130 <malloc+0x2134>
    int free0 = countfree();
    int free1 = 0;
    ...
    57d6:	76c080e7          	jalr	1900(ra) # 5f3e <printf>
    int free0 = countfree();
    ...
    5826:	71c080e7          	jalr	1820(ra) # 5f3e <printf>
      if(continuous != 2) {
    ...
    5836:	70c080e7          	jalr	1804(ra) # 5f3e <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58a4:	8f858593          	addi	a1,a1,-1800 # 8198 <malloc+0x219c>
    ...
    58ba:	93a58593          	addi	a1,a1,-1734 # 81f0 <malloc+0x21f4>
    ...
    58d0:	91c58593          	addi	a1,a1,-1764 # 81e8 <malloc+0x21ec>
  ...
  int continuous = 0;
    ...
    58fc:	8a850513          	addi	a0,a0,-1880 # 81a0 <malloc+0x21a4>
    5900:	00000097          	auipc	ra,0x0
    5904:	63e080e7          	jalr	1598(ra) # 5f3e <printf>
    exit(1);
    5908:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5928:	8ac50513          	addi	a0,a0,-1876 # 81d0 <malloc+0x21d4>
    592c:	00000097          	auipc	ra,0x0
    5930:	612080e7          	jalr	1554(ra) # 5f3e <printf>
  exit(0);
    5934:	4501                	li	a0,0
...
putc(int fd, char c)
{
    5c66:	1101                	addi	sp,sp,-32
    5c68:	ec06                	sd	ra,24(sp)
    5c6a:	e822                	sd	s0,16(sp)
    5c6c:	1000                	addi	s0,sp,32
    5c6e:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5c72:	4605                	li	a2,1
    5c74:	fef40593          	addi	a1,s0,-17
    5c78:	00000097          	auipc	ra,0x0
    5c7c:	f6e080e7          	jalr	-146(ra) # 5be6 <write>
}
    5c80:	60e2                	ld	ra,24(sp)
    5c82:	6442                	ld	s0,16(sp)
    5c84:	6105                	addi	sp,sp,32
    5c86:	8082                	ret

0000000000005c88 <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    5c98:	c299                	beqz	a3,5c9e <printint+0x16>
    5c9a:	0805c863          	bltz	a1,5d2a <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5c9e:	2581                	sext.w	a1,a1
  neg = 0;
    5ca0:	4881                	li	a7,0
    5ca2:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5ca8:	2601                	sext.w	a2,a2
    5caa:	00003517          	auipc	a0,0x3
    5cae:	8b650513          	addi	a0,a0,-1866 # 8560 <digits>
    5cb2:	883a                	mv	a6,a4
    5cb4:	2705                	addiw	a4,a4,1
    5cb6:	02c5f7bb          	remuw	a5,a1,a2
    5cba:	1782                	slli	a5,a5,0x20
    5cbc:	9381                	srli	a5,a5,0x20
    5cbe:	97aa                	add	a5,a5,a0
    5cc0:	0007c783          	lbu	a5,0(a5)
    5cc4:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5cc8:	0005879b          	sext.w	a5,a1
    5ccc:	02c5d5bb          	divuw	a1,a1,a2
    5cd0:	0685                	addi	a3,a3,1
    5cd2:	fec7f0e3          	bgeu	a5,a2,5cb2 <printint+0x2a>
  if(neg)
    5cd6:	00088b63          	beqz	a7,5cec <printint+0x64>
    buf[i++] = '-';
    5cda:	fd040793          	addi	a5,s0,-48
    5cde:	973e                	add	a4,a4,a5
    5ce0:	02d00793          	li	a5,45
    5ce4:	fef70823          	sb	a5,-16(a4)
    5ce8:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5cec:	02e05863          	blez	a4,5d1c <printint+0x94>
    5cf0:	fc040793          	addi	a5,s0,-64
    5cf4:	00e78933          	add	s2,a5,a4
    5cf8:	fff78993          	addi	s3,a5,-1
    5cfc:	99ba                	add	s3,s3,a4
    5cfe:	377d                	addiw	a4,a4,-1
    5d00:	1702                	slli	a4,a4,0x20
    5d02:	9301                	srli	a4,a4,0x20
    5d04:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5d08:	fff94583          	lbu	a1,-1(s2)
    5d0c:	8526                	mv	a0,s1
    5d0e:	00000097          	auipc	ra,0x0
    5d12:	f58080e7          	jalr	-168(ra) # 5c66 <putc>
  while(--i >= 0)
    5d16:	197d                	addi	s2,s2,-1
    5d18:	ff3918e3          	bne	s2,s3,5d08 <printint+0x80>
}
    ...
    5d26:	6121                	addi	sp,sp,64
    5d28:	8082                	ret
    x = -xx;
    5d2a:	40b005bb          	negw	a1,a1
    neg = 1;
    5d2e:	4885                	li	a7,1
    x = -xx;
    5d30:	bf8d                	j	5ca2 <printint+0x1a>

0000000000005d32 <vprintf>:
}
...
{
    5d32:	7119                	addi	sp,sp,-128
    5d34:	fc86                	sd	ra,120(sp)
    5d36:	f8a2                	sd	s0,112(sp)
    5d38:	f4a6                	sd	s1,104(sp)
    5d3a:	f0ca                	sd	s2,96(sp)
    5d3c:	ecce                	sd	s3,88(sp)
    5d3e:	e8d2                	sd	s4,80(sp)
    5d40:	e4d6                	sd	s5,72(sp)
    5d42:	e0da                	sd	s6,64(sp)
    5d44:	fc5e                	sd	s7,56(sp)
    5d46:	f862                	sd	s8,48(sp)
    5d48:	f466                	sd	s9,40(sp)
    5d4a:	f06a                	sd	s10,32(sp)
    5d4c:	ec6e                	sd	s11,24(sp)
    5d4e:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    5d54:	18090f63          	beqz	s2,5ef2 <vprintf+0x1c0>
    5d58:	8aaa                	mv	s5,a0
    5d5a:	8b32                	mv	s6,a2
  ...
  state = 0;
    ...
    5d62:	02500a13          	li	s4,37
      if(c == 'd'){
    5d66:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5d6a:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5d6e:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5d72:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5d76:	00002b97          	auipc	s7,0x2
    5d7a:	7eab8b93          	addi	s7,s7,2026 # 8560 <digits>
    5d7e:	a839                	j	5d9c <vprintf+0x6a>
        putc(fd, c);
    5d80:	85ca                	mv	a1,s2
    5d82:	8556                	mv	a0,s5
    5d84:	00000097          	auipc	ra,0x0
    5d88:	ee2080e7          	jalr	-286(ra) # 5c66 <putc>
    5d8c:	a019                	j	5d92 <vprintf+0x60>
    } else if(state == '%'){
    5d8e:	01498f63          	beq	s3,s4,5dac <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5d92:	0485                	addi	s1,s1,1
    5d94:	fff4c903          	lbu	s2,-1(s1)
    5d98:	14090d63          	beqz	s2,5ef2 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5d9c:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5da0:	fe0997e3          	bnez	s3,5d8e <vprintf+0x5c>
      if(c == '%'){
    5da4:	fd479ee3          	bne	a5,s4,5d80 <vprintf+0x4e>
        state = '%';
    5da8:	89be                	mv	s3,a5
    5daa:	b7e5                	j	5d92 <vprintf+0x60>
      if(c == 'd'){
    5dac:	05878063          	beq	a5,s8,5dec <vprintf+0xba>
      } else if(c == 'l') {
    5db0:	05978c63          	beq	a5,s9,5e08 <vprintf+0xd6>
      } else if(c == 'x') {
    5db4:	07a78863          	beq	a5,s10,5e24 <vprintf+0xf2>
      } else if(c == 'p') {
    5db8:	09b78463          	beq	a5,s11,5e40 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5dbc:	07300713          	li	a4,115
    5dc0:	0ce78663          	beq	a5,a4,5e8c <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5dc4:	06300713          	li	a4,99
    5dc8:	0ee78e63          	beq	a5,a4,5ec4 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5dcc:	11478863          	beq	a5,s4,5edc <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5dd8:	e92080e7          	jalr	-366(ra) # 5c66 <putc>
        putc(fd, c);
    5ddc:	85ca                	mv	a1,s2
    5dde:	8556                	mv	a0,s5
    5de0:	00000097          	auipc	ra,0x0
    5de4:	e86080e7          	jalr	-378(ra) # 5c66 <putc>
      }
      state = 0;
    5de8:	4981                	li	s3,0
    5dea:	b765                	j	5d92 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5dfe:	e8e080e7          	jalr	-370(ra) # 5c88 <printint>
    5e02:	8b4a                	mv	s6,s2
      state = 0;
    5e04:	4981                	li	s3,0
    5e06:	b771                	j	5d92 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    5e1a:	e72080e7          	jalr	-398(ra) # 5c88 <printint>
    5e1e:	8b4a                	mv	s6,s2
      state = 0;
    5e20:	4981                	li	s3,0
    5e22:	bf85                	j	5d92 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    5e36:	e56080e7          	jalr	-426(ra) # 5c88 <printint>
    5e3a:	8b4a                	mv	s6,s2
      state = 0;
    5e3c:	4981                	li	s3,0
    5e3e:	bf91                	j	5d92 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
  ...
  putc(fd, '0');
    ...
    5e56:	e14080e7          	jalr	-492(ra) # 5c66 <putc>
  putc(fd, 'x');
    5e5a:	85ea                	mv	a1,s10
    5e5c:	8556                	mv	a0,s5
    5e5e:	00000097          	auipc	ra,0x0
    5e62:	e08080e7          	jalr	-504(ra) # 5c66 <putc>
    5e66:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5e68:	03c9d793          	srli	a5,s3,0x3c
    5e6c:	97de                	add	a5,a5,s7
    5e6e:	0007c583          	lbu	a1,0(a5)
    5e72:	8556                	mv	a0,s5
    5e74:	00000097          	auipc	ra,0x0
    5e78:	df2080e7          	jalr	-526(ra) # 5c66 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5e7c:	0992                	slli	s3,s3,0x4
    5e7e:	397d                	addiw	s2,s2,-1
    5e80:	fe0914e3          	bnez	s2,5e68 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5e84:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5e88:	4981                	li	s3,0
    5e8a:	b721                	j	5d92 <vprintf+0x60>
        s = va_arg(ap, char*);
    5e8c:	008b0993          	addi	s3,s6,8
    5e90:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5e94:	02090163          	beqz	s2,5eb6 <vprintf+0x184>
        while(*s != 0){
    5e98:	00094583          	lbu	a1,0(s2)
    5e9c:	c9a1                	beqz	a1,5eec <vprintf+0x1ba>
          putc(fd, *s);
    5e9e:	8556                	mv	a0,s5
    5ea0:	00000097          	auipc	ra,0x0
    5ea4:	dc6080e7          	jalr	-570(ra) # 5c66 <putc>
          s++;
    5ea8:	0905                	addi	s2,s2,1
        while(*s != 0){
    5eaa:	00094583          	lbu	a1,0(s2)
    5eae:	f9e5                	bnez	a1,5e9e <vprintf+0x16c>
        s = va_arg(ap, char*);
    5eb0:	8b4e                	mv	s6,s3
      state = 0;
    5eb2:	4981                	li	s3,0
    5eb4:	bdf9                	j	5d92 <vprintf+0x60>
          s = "(null)";
    5eb6:	00002917          	auipc	s2,0x2
    5eba:	6a290913          	addi	s2,s2,1698 # 8558 <malloc+0x255c>
        while(*s != 0){
    5ebe:	02800593          	li	a1,40
    5ec2:	bff1                	j	5e9e <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5ec4:	008b0913          	addi	s2,s6,8
    5ec8:	000b4583          	lbu	a1,0(s6)
    5ecc:	8556                	mv	a0,s5
    5ece:	00000097          	auipc	ra,0x0
    5ed2:	d98080e7          	jalr	-616(ra) # 5c66 <putc>
    5ed6:	8b4a                	mv	s6,s2
      state = 0;
    5ed8:	4981                	li	s3,0
    5eda:	bd65                	j	5d92 <vprintf+0x60>
        putc(fd, c);
    5edc:	85d2                	mv	a1,s4
    5ede:	8556                	mv	a0,s5
    5ee0:	00000097          	auipc	ra,0x0
    5ee4:	d86080e7          	jalr	-634(ra) # 5c66 <putc>
      state = 0;
    5ee8:	4981                	li	s3,0
    5eea:	b565                	j	5d92 <vprintf+0x60>
        s = va_arg(ap, char*);
    5eec:	8b4e                	mv	s6,s3
      state = 0;
    5eee:	4981                	li	s3,0
    5ef0:	b54d                	j	5d92 <vprintf+0x60>
    }
  }
}
    5ef2:	70e6                	ld	ra,120(sp)
    5ef4:	7446                	ld	s0,112(sp)
    5ef6:	74a6                	ld	s1,104(sp)
    5ef8:	7906                	ld	s2,96(sp)
    5efa:	69e6                	ld	s3,88(sp)
    5efc:	6a46                	ld	s4,80(sp)
    5efe:	6aa6                	ld	s5,72(sp)
    5f00:	6b06                	ld	s6,64(sp)
    5f02:	7be2                	ld	s7,56(sp)
    5f04:	7c42                	ld	s8,48(sp)
    5f06:	7ca2                	ld	s9,40(sp)
    5f08:	7d02                	ld	s10,32(sp)
    5f0a:	6de2                	ld	s11,24(sp)
    5f0c:	6109                	addi	sp,sp,128
    5f0e:	8082                	ret
...
{
    5f10:	715d                	addi	sp,sp,-80
    5f12:	ec06                	sd	ra,24(sp)
    5f14:	e822                	sd	s0,16(sp)
    5f16:	1000                	addi	s0,sp,32
  ...
  vprintf(fd, fmt, ap);
    ...
    5f32:	e04080e7          	jalr	-508(ra) # 5d32 <vprintf>
}
...
free(void *ap)
{
    5f74:	1141                	addi	sp,sp,-16
    5f76:	e422                	sd	s0,8(sp)
    5f78:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5f7a:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5f7e:	00003797          	auipc	a5,0x3
    5f82:	4d27b783          	ld	a5,1234(a5) # 9450 <freep>
    5f86:	a805                	j	5fb6 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5f88:	4618                	lw	a4,8(a2)
    5f8a:	9db9                	addw	a1,a1,a4
    5f8c:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5f90:	6398                	ld	a4,0(a5)
    5f92:	6318                	ld	a4,0(a4)
    5f94:	fee53823          	sd	a4,-16(a0)
    5f98:	a091                	j	5fdc <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5f9a:	ff852703          	lw	a4,-8(a0)
    5f9e:	9e39                	addw	a2,a2,a4
    5fa0:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5fa2:	ff053703          	ld	a4,-16(a0)
    5fa6:	e398                	sd	a4,0(a5)
    5fa8:	a099                	j	5fee <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5faa:	6398                	ld	a4,0(a5)
    5fac:	00e7e463          	bltu	a5,a4,5fb4 <free+0x40>
    5fb0:	00e6ea63          	bltu	a3,a4,5fc4 <free+0x50>
{
    5fb4:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fb6:	fed7fae3          	bgeu	a5,a3,5faa <free+0x36>
    5fba:	6398                	ld	a4,0(a5)
    5fbc:	00e6e463          	bltu	a3,a4,5fc4 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fc0:	fee7eae3          	bltu	a5,a4,5fb4 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5fc4:	ff852583          	lw	a1,-8(a0)
    5fc8:	6390                	ld	a2,0(a5)
    5fca:	02059713          	slli	a4,a1,0x20
    5fce:	9301                	srli	a4,a4,0x20
    5fd0:	0712                	slli	a4,a4,0x4
    5fd2:	9736                	add	a4,a4,a3
    5fd4:	fae60ae3          	beq	a2,a4,5f88 <free+0x14>
    bp->s.ptr = p->s.ptr;
    5fd8:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5fdc:	4790                	lw	a2,8(a5)
    5fde:	02061713          	slli	a4,a2,0x20
    5fe2:	9301                	srli	a4,a4,0x20
    5fe4:	0712                	slli	a4,a4,0x4
    5fe6:	973e                	add	a4,a4,a5
    5fe8:	fae689e3          	beq	a3,a4,5f9a <free+0x26>
  } else
    p->s.ptr = bp;
    5fec:	e394                	sd	a3,0(a5)
  freep = p;
    5fee:	00003717          	auipc	a4,0x3
    5ff2:	46f73123          	sd	a5,1122(a4) # 9450 <freep>
}
    5ff6:	6422                	ld	s0,8(sp)
    5ff8:	0141                	addi	sp,sp,16
    5ffa:	8082                	ret

0000000000005ffc <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5ffc:	7139                	addi	sp,sp,-64
    5ffe:	fc06                	sd	ra,56(sp)
    6000:	f822                	sd	s0,48(sp)
    6002:	f426                	sd	s1,40(sp)
    6004:	f04a                	sd	s2,32(sp)
    6006:	ec4e                	sd	s3,24(sp)
    6008:	e852                	sd	s4,16(sp)
    600a:	e456                	sd	s5,8(sp)
    600c:	e05a                	sd	s6,0(sp)
    600e:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    6010:	02051493          	slli	s1,a0,0x20
    6014:	9081                	srli	s1,s1,0x20
    6016:	04bd                	addi	s1,s1,15
    6018:	8091                	srli	s1,s1,0x4
    601a:	0014899b          	addiw	s3,s1,1
    601e:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    6020:	00003517          	auipc	a0,0x3
    6024:	43053503          	ld	a0,1072(a0) # 9450 <freep>
    6028:	c515                	beqz	a0,6054 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    602a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    602c:	4798                	lw	a4,8(a5)
    602e:	02977f63          	bgeu	a4,s1,606c <malloc+0x70>
    6032:	8a4e                	mv	s4,s3
    6034:	0009871b          	sext.w	a4,s3
    6038:	6685                	lui	a3,0x1
    603a:	00d77363          	bgeu	a4,a3,6040 <malloc+0x44>
    603e:	6a05                	lui	s4,0x1
    6040:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    6044:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    6048:	00003917          	auipc	s2,0x3
    604c:	40890913          	addi	s2,s2,1032 # 9450 <freep>
  if(p == (char*)-1)
    6050:	5afd                	li	s5,-1
    6052:	a88d                	j	60c4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    6054:	0000a797          	auipc	a5,0xa
    6058:	c2478793          	addi	a5,a5,-988 # fc78 <base>
    605c:	00003717          	auipc	a4,0x3
    6060:	3ef73a23          	sd	a5,1012(a4) # 9450 <freep>
    6064:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    6066:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    606a:	b7e1                	j	6032 <malloc+0x36>
      if(p->s.size == nunits)
    606c:	02e48b63          	beq	s1,a4,60a2 <malloc+0xa6>
        p->s.size -= nunits;
    6070:	4137073b          	subw	a4,a4,s3
    6074:	c798                	sw	a4,8(a5)
        p += p->s.size;
    6076:	1702                	slli	a4,a4,0x20
    6078:	9301                	srli	a4,a4,0x20
    607a:	0712                	slli	a4,a4,0x4
    ...
    60a6:	bff1                	j	6082 <malloc+0x86>
  hp->s.size = nu;
    60a8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    60ac:	0541                	addi	a0,a0,16
    60ae:	00000097          	auipc	ra,0x0
    60b2:	ec6080e7          	jalr	-314(ra) # 5f74 <free>
  return freep;
    60b6:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    60ba:	d971                	beqz	a0,608e <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60bc:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60be:	4798                	lw	a4,8(a5)
    60c0:	fa9776e3          	bgeu	a4,s1,606c <malloc+0x70>
    if(p == freep)
    60c4:	00093703          	ld	a4,0(s2)
    60c8:	853e                	mv	a0,a5
    60ca:	fef719e3          	bne	a4,a5,60bc <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    60ce:	8552                	mv	a0,s4
    60d0:	00000097          	auipc	ra,0x0
    60d4:	b7e080e7          	jalr	-1154(ra) # 5c4e <sbrk>
  if(p == (char*)-1)
    60d8:	fd5518e3          	bne	a0,s5,60a8 <malloc+0xac>
        return 0;
    60dc:	4501                	li	a0,0
    60de:	bf45                	j	608e <malloc+0x92>
